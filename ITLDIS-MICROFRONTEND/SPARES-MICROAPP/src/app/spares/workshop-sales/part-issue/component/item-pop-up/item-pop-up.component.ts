...
export class ItemPopUpComponent implements OnInit {
  ...
  private getAvailableStock() {
    ...
    if (this.data.advancedSparePartIssue) {
      this.itemPopUpWebService.getAvailableStockForPartIssue(this.data.itemNumber, this.data.advancedSparePartIssue.id).subscribe(res => {
        //this.insertIssueQuantityIntoResponse(res, this.data.itemDetalList);
        this.itemNumberAvailableStockList = res;
      });
      return;
    }
    this.itemPopUpWebService.getAvailableStockByItemNumber(this.data.itemNumber, this.data.category).subscribe(res => {
      //this.insertIssueQuantityIntoResponse(res, this.data.itemDetalList);
