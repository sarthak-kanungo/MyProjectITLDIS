...
export class BreadcrumbComponent implements OnInit {
  ...
  isNoPath(functionalityName: string) {
    if (functionalityName !== undefined) {
      let noPathPages = ['master', 'itldis masters', 'sales and presales', 'purchase', 'pre sales', 'sales', 'branch transfer', 'activity', 'schemes', 'salesmasters', 'service', 'pre sales service', 'spares', 'spares master', 'counter sales', 'service activities claims', 'customer service', 'warranty', 'warranty claims', 'workshop sales','training']
