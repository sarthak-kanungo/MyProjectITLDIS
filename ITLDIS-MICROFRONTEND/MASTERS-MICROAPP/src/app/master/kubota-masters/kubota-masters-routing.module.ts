...
const routes: Routes = [
  ...
  { path: 'employee-master', loadChildren: () => import('./itldis-empolyee-master/itldis-empolyee-master.module').then(mod => mod.itldisEmpolyeeMasterModule) },
  { path: 'role-master', loadChildren: () => import('./role-master/role-master.module').then(mod => mod.RoleMasterModule) },
  { path: 'itldisuser', loadChildren: () => import('./itldis-user/itldis-user.module').then(mod => mod.itldisUserModule) },
  ...
  { path: 'source-master', loadChildren: () => import('./itldis-source-master/itldis-source-master.module').then(mod => mod.itldisSourceMasterModule) },
...
export class itldisMastersRoutingModule { }
