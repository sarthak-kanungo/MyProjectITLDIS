...
export class EmplyeeDetailsService {
  private readonly searchDesiganationLevelUrl = `${environment.baseUrl}${urlService.api}${urlService.itldisemployee}${urlService.designationLevelAuto}`
  private readonly submitEmployeeUrl = `${environment.baseUrl}${urlService.api}${urlService.itldisemployee}${urlService.add}`
  private readonly searchDesiganationUrl = `${environment.baseUrl}${urlService.api}${urlService.itldisemployee}${urlService.designationLevel}`
  private readonly getEmployeeByEmployeeCodeUrl = `${environment.baseUrl}${urlService.api}${urlService.itldisemployee}${urlService.getEmployeeByEmployeeCode}`
  private readonly updateEmployeeUrl = `${environment.baseUrl}${urlService.api}${urlService.itldisemployee}${urlService.update}`
  ...
  getitldisEmployeeById(employeeCode): Observable<BaseDto<Array<EmployeeDetail>>>
  {
