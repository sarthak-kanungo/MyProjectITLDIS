import { CreateDeliveryChallan, DcCustomerMaster, DcMachineDetails } from 'DeliveryChallanCreate';
...
export class DeliveryChallanCreateService {
  ...
  saveDeliveryChallan() {
    ...
    console.log(this.deliveryChallanMainData)
  ...
  approveDc(dcId: string) {
    let approveObj = {};
    approveObj['approvalFlag'] = true;
    approveObj['dcId'] = dcId;
    approveObj['userId'] = this.loginFormService.getLoginUserId();
  ...
  printDC(dcno:string,gatepassno:string, printStatus:string){
