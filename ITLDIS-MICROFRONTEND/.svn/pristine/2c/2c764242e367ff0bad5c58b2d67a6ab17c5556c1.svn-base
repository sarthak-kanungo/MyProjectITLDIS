...
export class ReportingEmployeeService {
 private readonly getEmployeeNameByEmployeeCodeUrl=`${environment.baseUrl}${urlService.api}${urlService.kubotaemployee}${urlService.getEmployeeNameByEmployeeCode}`
  // GET /api/kubotaemployee/getEmployeeNameByEmployeeCode
