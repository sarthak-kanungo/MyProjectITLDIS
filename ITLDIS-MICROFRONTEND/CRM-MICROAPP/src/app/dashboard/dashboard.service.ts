...
export class DashboardService {
  ...
  private static readonly getFunctionalityMappedToUserUrl = `${ environment.baseUrl }${ urlService.api }${ urlService.itldisuser }${ urlService.getFunctionalityMappedToUser }`;
