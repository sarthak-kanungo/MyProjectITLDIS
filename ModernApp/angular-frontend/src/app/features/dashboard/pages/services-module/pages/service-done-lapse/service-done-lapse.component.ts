...
@Component({
    selector: 'app-service-done-lapse',
    standalone: true,
    imports: [CommonModule, FormsModule, RouterModule],
    providers: [DatePipe],
    templateUrl: './service-done-lapse.component.html',
    styleUrls: ['./service-done-lapse.component.scss']
})
export class ServiceDoneLapseComponent implements OnInit {
