      ...
      <mat-card>
        <mat-card-header>
          <mat-card-title>
            ...
            Service Due Date / Lapse Report
          </mat-card-title>
        </mat-card-header>
        <mat-card-content>
          <p>Service Due Date / Lapse Report functionality will be implemented here.</p>
        </mat-card-content>
      </mat-card>
    </div>
  `,
...
export class ServiceDueDateComponent implements OnInit, AfterViewInit {
  ngOnInit(): void {
