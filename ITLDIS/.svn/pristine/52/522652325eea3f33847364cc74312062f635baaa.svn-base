 ...
 */
public class EAMG_ModifyPartByExcel extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm  form,
       ...
       try{
        ...
        result= new EAMG_ValidateXlsWithTemplate().isPartExcelValidated(xlsfile, conn);
        ...
        if(!result.equals("success"))
        {
		  ...
		  {
                 insertionResult=new EAMGPartDAO_R().updatePartExcel(conn, xlsfile,"PRT");
