...
//                window.scrollTo(0,0);//go to top of page
    ...
    function cUDAction(str, row,strVal,subContentDesc,content_ID)
    {
          var name="";
        if(str == 'add'){
            var contents = document.getElementsByName("subContent");
            var elementArr=new Array('Sub Content Description','Content ID');
            var strValue=null;
            var strObject=null;
            ...
            for(var i=0;i<elementArr.length;i++)
            {
             ...
             var oRows = document.getElementById("myTable").getElementsByTagName("TR");
                   var rowLength = oRows.length - 2;
                  // alert(rowLength);
               var objSpecExp = /['\*\@\!\~\`\$\%\=\|\:\;\<\>\?\+\"\^]/g;
               for(var i=2;i<=rowLength;i++){
                if(document.getElementById("Sub Content Description"+i).value==""){
                    document.getElementById("Sub Content Description"+i).focus();
                    document.getElementById("msg_saveFAILED").style.display = "";
                    document.getElementById("msg_saveFAILED").innerHTML="Please enter value in Sub Content Description field";
                    return false;
                }
                if(objSpecExp.test(document.getElementById("Sub Content Description"+i).value)){
                    document.getElementById("Sub Content Description"+i).value="";
                    document.getElementById("Sub Content Description"+i).focus();
                    document.getElementById("msg_saveFAILED").style.display = "";
            ...
            var contentID = TrimAll(document.getElementById("Content ID").value);
            //var name = TrimAll(document.getElementById("Sub Content Description").value);
            document.getElementById("subcontentAdd").submit();
            <%--var url="<%=cntxpath%>/masterAction.do?option=manageSubContentMaster&type="+str+"&name="+name+"&contentID="+contentID+"&t="+new Date().getTime();--%>
        }
        else{
            var url="<%=cntxpath%>/masterAction.do?option=manageSubContentMaster&status="+str+"&subContentDesc="+subContentDesc+"&type="+str+"&id="+strVal+"&contentID="+content_ID+"&t="+new Date().getTime();
        //alert(url);
            ...
            if (xmlHttp.readyState == 4 || xmlHttp.readyState == "complete")
            {
                ...
                else
                {
                    ...
                    if(str != 'add' && res.split("@@")[0] =='Success'){
                        if(str=='Y'){
                            document.getElementById('st'+row).innerHTML="<a href=\"javascript:void(0)\" onclick=\"cUDAction('N','"+row+"','"+strVal+"','"+subContentDesc+"','"+content_ID+"')\"  class=\"headingSpas\" style=\"color: blue;\" >N</a>";
                        }
                        else if(str=='N'){
                            document.getElementById('st'+row).innerHTML="<a href=\"javascript:void(0)\" onclick=\"cUDAction('Y','"+row+"','"+strVal+"','"+subContentDesc+"','"+content_ID+"')\"  class=\"headingSpas\" style=\"color: blue;\" >Y</a>";
                        }
                    }
                    if(str=='Y' && res.split("@@")[0] =='subContentExist' ){
                        document.getElementById('st'+row).innerHTML="<a href=\"javascript:void(0)\" onclick=\"cUDAction('Y','"+row+"','"+strVal+"','"+subContentDesc+"','"+content_ID+"')\"  class=\"headingSpas\" style=\"color: blue;\" >Y</a>";
                    }
                    if(str == 'add' && res.split("@@")[0] =='Success'){
                        //submitForm();
                        document.getElementById("msg_saveFAILED").innerHTML=res.split("@@")[1];
                        //document.getElementById("Sub Content Description").value='';
    ...
    function editRow(name, row,id,conId){
        ...
        document.getElementById('imageButton'+row).innerHTML="<input type=button name=\"apply\" class=\"headingSpas\" value=\"Apply\" onclick=\"updateAction('edit', "+row+",'"+id+"','"+conId+"')\"/>";
        document.getElementById('contentName' + row).innerHTML = "<select name='name' \n\
class=\"headingSpas\" id='Content ID" + row + "' style='width:220px'><option value='' >--Select Here--</option><c:forEach items='${contentList}'  var='labelValue'  varStatus='status'><option value='${labelValue.value}@@${labelValue.label}' title='${labelValue.label}'>${labelValue.label}</option></c:forEach></select>";
document.getElementById('Content ID' + row).value=conId;

 }

    function updateAction(str, row,id,conId)
    {
        ...
        if(temp)
        {
            document.getElementById("newName"+row).focus();
            document.getElementById("msg_saveFAILED").style.display = "";
            document.getElementById("msg_saveFAILED").innerHTML="Special Characters are not allowed in Sub Content Description field";
       window.scrollTo(0,0);//go to top of page
            return false;
        }

        var name = TrimAll(document.getElementById("newName"+row).value).replace('&','@@');
         var contentId = TrimAll(document.getElementById("Content ID"+row).value);
        var url="<%=cntxpath%>/masterAction.do?option=manageSubContentMaster&id="+id+"&subContentDesc="+name+"&type="+str+"&contentID="+ (document.getElementById("Content ID"+row).value).split("@@")[0]+"&t="+new Date().getTime();
//alert(url)
        xmlHttp = GetXmlHttpObject();
        xmlHttp.onreadystatechange = function()
        {
            if (xmlHttp.readyState == 4 || xmlHttp.readyState == "complete")
            {
                ...
                { res = trim(xmlHttp.responseText);
                    ...
                    if(str != 'add' && res.split("@@")[0] =='Success'){
                        ...
                        document.getElementById('contentName'+row).innerHTML=contentId.split("@@")[1];
                        document.getElementById('imageButton'+row).innerHTML="<img src=\"images/edit.gif\" onclick=\"editRow('"+name+"',"+row+",'"+id+"','"+conId+"')\" title=\"Edit\"/>";
                    }
                } }
        };
        xmlHttp.open("GET",url, true);
    ...
    function uploadExcel()
    {
       ...
       <%-- alert(str);--%>
    var url="<%=cntxpath%>/masterAction.do?option=uploadSubContentMaster&file="+str+"&contentID="+contentID;
...
//                    }
    ...
    function addRowContent(in_tbl_name)
    {
        ...
        var strHtml2="&nbsp;&nbsp;<input type=\"text\" name=\"subContent\"  id=\"Sub Content Description"+rowcount+"\" class=\"headingSpas\"  maxlength=\"200\" style=\"width:200px\" onblur=\"this.value=TrimAll(this.value)\" align=\"left\"/>"
...
<div class="contentmain1">
    <div class="breadcrumb_container">
        <ul>
            <li class="breadcrumb_link"><a href='<%=cntxpath%>/masterAction.do?option=initOptions'>MASTERS</a>MANAGE CHECKLIST SUB CONTENT</li>
    ...
    <center>
        ...
        <div class="content_right1">
            ...
            <div class="con_slidediv1" style="position: relative;width: 100%">
                ...
                <h1>MANAGE CHECKLIST SUB CONTENT</h1>
                ...
                <table cellspacing=1 cellpadding=5 border=0 width=100%>
                    ...
                    <tr height=30 bgcolor="#FFFFFF">
                        <td align= center class="headingSpas">
                            <html:form action="masterAction.do?option=initSubContentMaster&param=search" method="post" styleId="searchBy" onsubmit="donotsubmit();">
                                <table width=100%  border=0 cellspacing=0 cellpadding=0 bgcolor=#cccccc>
                                    <tr bgcolor="#FFFFFF">

                                        <td  style="padding-left:10px" width="20%" class="headingSpas" nowrap align="left">Sub Content Description</td>
                        ...
                        <tr height=25 bgcolor="#FFFFFF">
                            <td align= center class="headingSpas">
                                <pg:pager url="masterAction.do" maxIndexPages="10" maxPageItems="10">
                                    <pg:param name="option" value="initSubContentMaster"/>
                                    ...
                                    <table  id="data" width=100%  border=0 cellspacing=1 cellpadding=1 bordercolor=#cccccc bgcolor=#cccccc>
                                        <tr  bgcolor="#eeeeee" height="20">
                                            ...
                                            <td   align="left" width="150"  class="headingSpas" nowrap><b>Sub Content Description</b></td>
                                            <td   align="left" width="150"  class="headingSpas" nowrap><b>Content</b></td>
                                        ...
                                        <logic:iterate id="subContentList" name="subContentList">
                                            <pg:item>
                                                <tr id ="${sno}" height="20">
                                                    <td align="center" bgcolor="#FFFFFF" width="25" class="headingSpas" style="padding-left:5px; padding-right: 5px">${sno}</td>
                                                    <td align="left" bgcolor="#FFFFFF" title="${subContentList.name}" width="150" class="headingSpas" style="padding-left:5px; padding-right: 5px">
                                                        <span id ="compType${sno}" >
                                                            ${subContentList.name}
                                                        </span>
                                                    </td>
                                                    <td align="left" bgcolor="#FFFFFF" title="${subContentList.contentdesc}" width="150" class="headingSpas" style="padding-left:5px; padding-right: 5px">
                                                        <span id ="contentName${sno}" >
                                                            ${subContentList.contentdesc}
                                                        </span>
                                                    </td>
                                                    ...
                                                    <td align="center" bgcolor="#FFFFFF" width="20" class="headingSpas" style="padding-left:5px; padding-right: 5px">
                                                        <span id ="imageButton${sno}" >
                                                            <img src="${pageContext.request.contextPath}/images/edit.gif" onclick="editRow('${subContentList.name}', ${sno},'${subContentList.id}','${subContentList.description}@@${subContentList.contentdesc}')" title="Edit"/>
                                                        </span>
                                                    </td>
                                                    <td align="center" bgcolor="#FFFFFF" width="25" class="headingSpas" style="padding-left:5px; padding-right: 5px">
                                                        <span id ="st${sno}" >
                                                            <a href="javascript:void(0)" onclick="cUDAction('${subContentList.status}', ${sno},'${subContentList.id}','${subContentList.name}','${subContentList.description}')"  class="headingSpas" style="color: blue;" >
                                                                ${subContentList.status}&nbsp;
                                                            </a>
                                                        </span>
                                                    </td>
                                                </tr>
                    ...
                    <tr bgcolor="#FFFFFF">
                        <td width=100% valign="top">
                            <form action="masterAction.do?option=manageSubContentMaster&type=add" method="post" id="subcontentAdd" name="subcontentAdd">
                                    ...
                                    <tr>
                                        <td width="100%" valign="top">
                                            <table id="myTable" width="100%" border="0" cellpadding="0" cellspacing="0" >
                                                <tr height="30" bgcolor="#FFFFFF">
                                                    <td style="padding-left:10px" width="20%" bgcolor="#FFFFFF" class="headingSpas" nowrap align="left">Select Content</td>
                                                    <td style="padding-left:10px" width="20%" bgcolor="#FFFFFF" class="headingSpas" nowrap align="left">
                                                        <select name='content_id' id='Content ID' class="headingSpas" style='width:200px !important'>
                                                            <option value='' >--Select Here--</option>
                                                            <c:forEach items='${contentList}'  var='labelValue'  varStatus='status'>
                                                ...
                                                <tr height="30" bgcolor="#FFFFFF">
                                                    ...
                                                    <td style="padding-left:10px;padding-bottom:2px" align="left" width="20%" >
                                                         <input type="text" name="subContent"  id="Sub Content Description" size='200' class="headingSpas"  maxlength="200" style="width:200px" onblur="this.value=TrimAll(this.value)"/>
                                                    </td>
                                                ...
                                                <tr height="30" bgcolor="#FFFFFF">
                                                    ...
                                                    <td  style="padding-left:10px" width="20%" class="headingSpas" nowrap align="left">
                                                    ...
                                                    <td style="padding-left:10px" width="20%" align="left">
                                                        <input type=button name="add" class="headingSpas" value="Add" onclick="addRowContent('myTable')" align="center"/> &nbsp;&nbsp; <input type=button name="add" class="headingSpas" value="Delete" onclick="deleteContentRow('myTable')" align="center"/>
                                                    </td>
