...
<script>
    ...
    function submitForm() {
        ...
        ,'payeePinCode','Registration No','HMR','payee Mobile Phone','itlPolicyNo','itlPolicyDate');
        ...
        for (var i = 0; i < elementArr.length; i++) {
         ...
         res = validateItlPolicyNoAndDate();
         if(res == false)
        	 return false;
    ...
    function validateItlPolicyNoAndDate() {
        var itlPolicyNo = document.getElementById('itlPolicyNo').value;
        if (itlPolicyNo === '') {
            alert('ITL Policy number is mandatory');
            document.getElementById('itlPolicyNo').focus();
            return false;
        }
        
        var itlPolicyDate = document.getElementById('itlPolicyDate').value;
        if (itlPolicyDate === '') {
            alert('ITL Policy date is mandatory');
            document.getElementById('itlPolicyDate').focus();
            return false;
        }
        return true;
    }
	...
	<center>
		<div class="content_right1">
			<div class="con_slidediv2">
				<h1>
					<bean:message key="label.common.editItlExtWarranty" />
				</h1>
										...
										<table id="data" width=100% border=0 cellspacing=1
											...
											<tr height=25 bgcolor="#FFFFFF">
												<td colspan="6" align=center class="headingSpas"><html:form
														action="serviceProcess.do?option=updateItlExtWarranty"
														...
														<table width=100% border=0 cellspacing=0 cellpadding=4
															...
															<tr class="headingSpas" align="left" bgcolor="#FFFFFF">
																<td align="right"><bean:message
																		key="label.common.itlPolicyNo" /><span class="mandatory">*</span></td>
																<td class="headingSpas" align="left"><input type="text" 
																	name="itlPolicyNo" id="itlPolicyNo" 
																	style="width: 150px !important" 
																	onblur="this.value=TrimAll(this.value)" maxlength="18" />
																</td>

																<td align="right" style="white-space: nowrap"><label><bean:message
																			key="label.common.itlPolicyDate" /><span class="mandatory">*</span></label></td>
																<td align="left">
                                                               <input name="itlPolicyDate" type="text" class="datepicker" id="itlPolicyDate" value="" onkeydown="return false;"/>
                                                                </td>

																
																 <td class="headingSpas" nowrap align="right"></td>
