...
<html:html >
    ...
    <body>
         <%
                    String tdData = "MANAGE KIT >> MODIFY KIT >> MODIFICATION PARAMETERS";
            ...
            <table width="700" border="0" cellspacing="1" cellpadding="1">
                ...
                <tr>
                    <td align="center"><table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC">
                            <tr>
                                <td height="25" align="left" class="blue"><b class="path">&nbsp;Manage Kit >> Kit Modify >> Modification Parameters</b></td>
                            </tr>
                        </table></td>
                </tr>
                <tr>
