<%-- 
    Document   : uploadStockAdjustment
    Created on : Dec 9, 2015, 12:49:06 PM
...
<html>
    ...
    <script language="javascript">
        ...
        function validateExcel()
        {
           ...
           document.form1.action="<%=cntxpath%>/inventoryAction.do?option=stockAdjustmentExcel";
    ...
    <div class="contentmain1">
        <div class="breadcrumb_container">
            <ul class="hText">
                <li class="breadcrumb_link"><a href ='<%=contextPath%>/inventoryAction.do?option=initInvOptions'>SPARES</a></li>
                <li class="breadcrumb_link">UPLOAD STOCK ADJUSTMENT</li>
            </ul>
        </div>
        <br/>
        <center>
            <div class="content_right1">
                <div class="con_slidediv2" style="position: relative;width: 100%">
                    <h1 class="hText">UPLOAD STOCK ADJUSTMENT</h1>
                            ...
                            <td align= center class="headingSpas">
                                <form name="form1" onsubmit="return check_method_select();" enctype="multipart/form-data" method="post">
                                    ...
                                    <table width="95%" border="0" cellspacing="2" cellpadding="2">
                                        ...
                                        <tr>
                                            <td colspan="2" align="right" style="padding-right: 20px" ><em><a href="<%=mainURL%>/dealer/templates/stockAdjustment_Template.xls"   class="red-for-temmplate-link" style="font-size: 12px" >* Click Here To Download Template </a><span class="red-for-temmplate">(xls).</span></em></td>
                                        </tr>
                                        <tr>
