    ...
    <body>
        <%
					...
					if (modifyFlag == null) {
						 ...
						 tdData = "MANAGE COMPONENT >>ADD NEW COMPONENT";
					} else {
						 heading = "MODIFY COMPONENT";
						 tdData = "MANAGE COMPONENT >>MODIFY COMPONENT";
					}
                ...
                <tr>
                    <td>
                        <table align="center" >
                            <td valign="center" class="red">
                                <%if (exists.size() > 1) {%>
                                Following Components are Already Exist.
                                <%} else {%>
										  Following Component is Already Exist.
                                <%}%>
                            </td>
                        </table>
                    </td>
								...
								<div style="overflow:auto; height:250px;width:267px;">
									 <table width="250" border="0" cellpadding="0" cellspacing="1" class="tableStyle" >
										  <tr>
												...
												<td  align="left" class="tdstyle"><strong >&nbsp;Component No.</strong></td>
