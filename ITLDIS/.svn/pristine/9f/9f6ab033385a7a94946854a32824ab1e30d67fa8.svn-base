...
<script>
    ...
    function Export()
    {
        ...
        window.location.href='<%=cntxpath%>/reportAction.do?option=generateMisReport&etype=export&fromDate=<%=fromDate%>&toDate=<%=toDate%>&dealerCode=<%=dealerCode%>';
    }
</script>
    ...
    <center>
        <div class="content_right1">
            <div class="con_slidediv2" style="position: relative;width: 100%">
                ...
                <%@include file="jasperReport/dmis_spareLubes_Report.jsp" %>
                <br>
                <%@include file="jasperReport/DMISNumberOfJobCard.jsp" %>
                <%@include file="jasperReport/dmis_jobTypes_Report.jsp" %>
                <br>
                <%@include file="jasperReport/warrantyClaimed.jsp" %>
            </div>
        </div>
    </center>
</div>