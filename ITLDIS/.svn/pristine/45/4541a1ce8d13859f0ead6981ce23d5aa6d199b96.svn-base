<%--
    ...
    Created on : July 18, 2016, 03:30:06 PM
...
<div class="contentmain1">
    <div class="breadcrumb_container">
        <ul>
            ...
            <li class="breadcrumb_link"><label><bean:message key="label.common.downloadPartList" /></label></li>
        </ul>
    </div>
    ...
    <center>
        <div class="content_right1">
            <div class="con_slidediv1" style="position: relative;width: 100%">
                <h1><bean:message key="label.common.downloadPartList" /></h1>
                ...
                <table id="data" width=100%  border=0 cellspacing=1  cellpadding=4 bordercolor=#cccccc bgcolor=#cccccc>
                    ...
                    <tr height=50 bgcolor="#FFFFFF">
                        <td colspan="11" align= center class="headingSpas">
                            <html:form action="masterAction.do?option=exportToExcelPartlistMaster" method="post" styleId="searchBy" onsubmit="donotsubmit();">
                                <table width=100%  border=0 cellspacing=0 cellpadding=4 bgcolor=#cccccc>
                                   
                                    <tr bgcolor="#FFFFFF" >

                                        <td  style="padding-left:5px;width:12%" nowrap align="right" class="headingSpas">
                                            <bean:message key="label.report.PartNo"/>
                                        </td>
                                        <td align="left" style="padding-left:20px;width:20%" class="headingSpas" >
