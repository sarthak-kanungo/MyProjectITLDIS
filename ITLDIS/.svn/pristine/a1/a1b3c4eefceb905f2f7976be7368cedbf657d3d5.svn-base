...
<script type="text/javascript" language="javascript">
    ...
    function updateEwRefNo(ewLoaderId,chassisNo,dealerCode) {
        var strURL = '${pageContext.request.contextPath}/serviceProcess.do?option=editExtWarranty&ewRefNo='+ewLoaderId+'&chassisNo='+chassisNo+'&userCode='+dealerCode;
        window.open(strURL,'iji','width=980,height=600, resizable=no,scrollbars=no, status=0,titlebar=0,toolbar=0, addressbar=0,top=20,left=10');
    }
</script>
        ...
        <div class="contentmain1">
            <div class="breadcrumb_container">
                <ul class="hText">
                    ...
                    <li class="breadcrumb_link"><label><bean:message key="label.common.viewExtWarranty" /></label></li>
                </ul>
            </div>
                ...
                <div class="content_right1">
                    <div class="con_slidediv1" style="position: relative;width: 100%">
                        ...
                        <table id="data" width=100% border=0 cellspacing=1 cellpadding=4 bordercolor=#cccccc>
                            <form action="serviceProcess.do?option=viewExtendedWarranty&flag=check" onsubmit="" method="post" id="searchform">
                                ...
                                <tr>
                                    <td colspan="7">
                                        <pg:pager url="serviceProcess.do" maxIndexPages="12" maxPageItems="10">
                                            <pg:param name="option" value="viewExtendedWarranty"/>
                                            ...
                                            <table width="100%" border=0 cellspacing=1  cellpadding=4 bordercolor=#cccccc bgcolor="#cccccc" >
                                                <tr bgcolor="#eeeeee" height="20">
                                                    <td align="center" width="5%"  nowrap style="padding-left:3px;padding-right:3px;"><b><bean:message key="label.catalogue.sNo"/></b> </td>
                                                    <td align="left" width="12%" nowrap style="padding-left:3px;padding-right:3px;"><b><bean:message key="label.common.itlEwRef"/></b></td>
                                                    <td align="left" width="10%" nowrap style="padding-left:3px;padding-right:3px;"><b><bean:message key="label.common.dateSaleOfCertificate"/></b></td>
                                                    <td align="left" width="12%" nowrap style="padding-left:3px;padding-right:3px;"><b><bean:message key="label.common.Chassisno"/></b></td>
                                                    <td align="left" width="12%" nowrap style="padding-left:3px;padding-right:3px;"><b><bean:message key="label.common.modelName"/></b></td>
                                                    <td align="left" width="15%" nowrap style="padding-left:3px;padding-right:3px;"><b><bean:message key="label.common.nameOfCust"/></b></td>
                                                    <td align="left" width="8%" nowrap style="padding-left:3px;padding-right:3px;"><b><bean:message key="label.common.policyTerm"/></b></td>
                                                    <td align="left" width="8%" nowrap style="padding-left:3px;padding-right:3px;"><b><bean:message key="label.common.policyType"/></b></td>
                                                    <%if (!userFunctionalities.contains("101")) {%>
                                                    <td nowrap width="15%" align="left" style="padding-left:3px;font-weight:bold;white-space: nowrap" ><bean:message key="label.common.dealerName" /></td>
                                                    <%}%>
                                                ...
                                                <logic:iterate name="viewExpWarrList" id="expList">
                                                    <pg:item>
                                                        <tr bgcolor="#FFFFFF">
                                                            ...
                                                            <td align="left" style="padding-left:3px;"><span>${expList.policyTerm}</span></td>
                                                            <td align="center" style="padding-left:3px;"><span>${expList.policyType}</span></td>
                                                            <%if (!userFunctionalities.contains("101")) {%>
