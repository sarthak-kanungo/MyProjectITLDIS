...
<script>
    function printPDI()
    {
        var vinNo='${pdiform.vinNo}';
        var pdiNo='${pdiform.pdiNo}';
        var strURL = "${pageContext.request.contextPath}/pdiServiceProcess.do?option=viewPDIData&vinNo="+Base64.encode(vinNo.trim())+"&pdiNo="+Base64.encode(pdiNo.trim())+"&printPDI=true";
    ...
    $(document).ready(function(){
     $('.viewJobcardCloseAll').click(function(){
        var url = "serviceProcess.do?option=viewJobcard&jobCardNo="+Base64.encode($(this).attr("data-jobCardNo").trim())+"&vinNo="+ Base64.encode($(this).attr('data-vinNo').trim())+"&flag="+Base64.encode("PDI");
        $(this).attr('href',url);
     });
    });
                    ...
                    <tr bgcolor="#eeeeee" height="20" >
                        ...
                        <td align="right" style="padding-right:7px ">
                            <%if (userFunctionalities.contains("608"))
                                {%>
                                <c:if test="${pdiform.createJobCard}">
                                    <label >
                                        <%--<a href="<%=cntxpath%>/serviceCreateJC.do?option=initVehicleInformation&jobType=PDI&pathNm=fillJC&jobTypeStatus=PDI&chassisno=${pdiform.vinNo}" class="headingSpas1">--%>
                                        <a href="#" data-vinNo="${pdiform.vinNo}" data-jobCardNo="${pdiform.jobCardNo}" class="headingSpas1 viewJobcardCloseAll">
                                            <bean:message key="label.common.viewjobCard" />
                                        </a>
                                    </label>
                                        &nbsp
                                </c:if>
<%--                                    <c:if test="${pdiform.status eq 'true'}">
                                    <label >
                                        <a href="<%=cntxpath%>/serviceCreateJC.do?option=initVehicleInformation&jobType=PDI&pathNm=fillJC&jobTypeStatus=PDI&chassisno=${pdiform.vinNo}" class="headingSpas1">
                                        <a href="#" data-vinNo="${pdiform.vinNo}" data-jobCardNo="${pdiform.jobCardNo}" class="headingSpas1 viewJobcardCloseAll">
                                            <bean:message key="label.common.createjobcard" />
                                        </a>
                            ...
                            <%}%>
                            <a href="#"><img src='<%=cntxpath%>/image/print-icon.png' alt='Get Suggestions' name="img1" border='0' title="print"  onclick="printPDI();"/></a>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
                            <table width="100%" border="0" align="center" cellpadding="1" cellspacing="5"  >
                                ...
                                <tr>
                                    <td width="15%" align="right"><span class="headingSpas">
                                            <label><B><bean:message key="label.common.Productcategory" />: </B></label></span>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td align="right" style=""><span class="headingSpas">
                                            <label><B><bean:message key="label.common.Modelfamilydesc" />: </B></label>
                                        </span>
                                    </td>
                                    ...
                                    <td align="right" style="" ><span class="headingSpas">
                                            <label><B><bean:message key="label.common.Modelcodedesc" />: </B></label>
                                        </span></td>
                                ...
                                <tr>
                                    ...
                                    <td align="left" style="white-space: nowrap"><span class="headingSpas">${pdiform.invoiceDate}</span>
                                        <%--<input name="invoiceDate" type="text" class="datepicker" id="Invoice Date" size="15" value="${pdiform.invoiceDate}"  onkeydown="return false;"/>--%>
                                    </td>
                                    <td align="right"><span class="headingSpas">
                                            <label><B><bean:message key="label.common.tractorrecieveddate" />: </B></label>
                                        </span></td>
                                    <td align="left" style="white-space: nowrap"><span class="headingSpas">${pdiform.jobCardDate}</span>
                                        <%--<input name="jobCardDate" type="text" id="Tractor In Date" size="15" value="${pdiform.jobCardDate}" readonly="true" onkeydown="return false;"/>--%>
                                    </td>
                                    <td align="right" style="" ><span class="headingSpas">
                                            <label><B> <bean:message key="label.common.pdiNoDate" />: </B></label>
                                        </span></td>
                                    <td align="left" id="saledatetd"><span class="headingSpas">${pdiform.pdiNo}&nbsp;[${pdiform.pdiDate}]</span>
                                        <%--<input name="pdiDate" type="text" id="PDI Date" value="${pdiform.pdiDate}" readonly="true" onkeydown="return false;"/>--%>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="right" style="" ><span class="headingSpas">
                                    ...
                                    <td align="left" ><span class="headingSpas">${pdiform.dealerName}&nbsp;[${pdiform.dealerCode}]</span>
                                        <%--<input name="engineNumber" type="text" id="Engine Number" value="${pdiform.engineNumber}" readonly="true" onkeydown="return false;"/>--%>
                                    </td>
                                ...
                                <tr>
                                    <td align="right" style="" ><span class="headingSpas">
                                            <label><%--<B>  <bean:message key="label.common.installer" />&nbsp;<bean:message key="label.common.name" />: </B>--%>
                                            <B>  <bean:message key="label.pdi.pdiDoneBy" />: </B>
                                            </label>
                                        </span>
                                    </td>
                                    <td align="left">
