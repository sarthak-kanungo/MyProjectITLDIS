<%-- 
    ...
    Created on : 11-Feb-2015, 15:27:56
    ...
    <%-- function Export(wClaimNo,flag)
     {
         ...
         function Export(pono)
         {
             ...
             window.location.href='<%=cntxpath%>/inventoryAction.do?option=viewOrderDetail&etype=export&poNo='+pono+'&flag=check&etype=export';
         }
</script>
...
<div class="contentmain1">
    <div class="breadcrumb_container">
        <ul class="hText">
            ...
            <li class="breadcrumb_link"><a href='${pageContext.request.contextPath}/inventoryAction.do?option=viewOrder'><bean:message key="label.spare.viewOrder" /></a></li>
                                            ...
                                            <c:forEach items="${partList}" var="partList">
                                                 <c:if test="${partList.colorId eq 0 }">
                                                  ...
                                                  <tr >
                                                      ...
                                                      <td align="center" bgcolor="${bgcolor}"  class="headingSpas"  style="color: ${color}" >${i}.</td>
                                                    <td align="left" bgcolor="${bgcolor}" style="color: ${color}" title="${partList.partno}" class="headingSpas" style="padding-left:5px; " >
                                                        ${partList.partno}
                                                    </td>
                                                    <td align="left" bgcolor="${bgcolor}" style="color: ${color}" title="${partList.part_desc}" class="headingSpas" style="padding-left:5px; " >
                                                        ${partList.part_desc}
                                                    </td>
                                                    <%--                              <td align="left" bgcolor="#FFFFFF" title="${partList.partStatus}" class="headingSpas" style="padding-left:5px; " >
                                                                                      ${partList.partStatus}
                                                                                  </td>--%>
                                                    <td align="center" bgcolor="${bgcolor}" style="color: ${color}" title="${partList.qty}" class="headingSpas" style="padding-left:5px; " >
                                                        ${partList.qty}
                                                    </td>
                                                    <td align="center" bgcolor="${bgcolor}" style="color: ${color}" title="${partList.erpPendingQty}" class="headingSpas" style="padding-left:5px; " >
                                                        ${partList.erpPendingQty}
                                                    </td>
                                                    <td align="right" bgcolor="${bgcolor}" style="color: ${color}" title="${partList.finalamount}" class="headingSpas" style="padding-right:5px; " >
                                                        ${partList.finalamount}
                                                    </td>
                                                    <td align="right" bgcolor="${bgcolor}" style="color: ${color}" title="${partList.amountPerPrice}" class="headingSpas" style="padding-right:5px; " >
