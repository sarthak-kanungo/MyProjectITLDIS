<%--
    Document   : v_DealerList_master
    Created on : Dec 24, 2015, 11:37:01 AM
    ...
    <%--if (str == 'add') {
        ...
        var strObject = null;
            ...
            var url = "<%=cntxpath%>/UserManagement.do?option=manageUser&type=" + str + "&name=" + name + "&description=" + desc + "&t=" + new Date().getTime();
                ...
                var url = "<%=cntxpath%>/UserManagement.do?option=manageDealer&status=" + str + "&type=" + str + "&dealerCode=" + strVal + "&t=" + new Date().getTime();
    <%-- }--%>
            //alert(url);
...
<div class="contentmain1">
    <div class="breadcrumb_container">
        <ul>
            ...
            <li class="breadcrumb_link">MANAGE DEALER</li>
                ...
                <table cellspacing=1 cellpadding=5 border=0 width=100% >
                    <tr height=30 bgcolor="#FFFFFF">
                        <td align= center class="headingSpas">
                            <html:form action="UserManagement.do?option=initDealer" method="post" styleId="searchBy" >
                                <table width=100%  border=0 cellspacing=0 cellpadding=0>
                                    <tr bgcolor="#FFFFFF">

                                        <td  style="padding-left:10px" width="20%" class="headingSpas" nowrap align="left">Dealer Name</td>
                                        ...
                                        <td style="padding-left:10px" width="30%" align="left" >
                                            <B><a href='<%=cntxpath%>/UserManagement.do?option=addDealer'>ADD NEW DEALER</a></B>
                                        </td>
                        ...
                        <tr height=25 bgcolor="#FFFFFF">
                            <td align= center class="headingSpas">
                                <pg:pager url="UserManagement.do" maxIndexPages="10" maxPageItems="10">
                                    <pg:param name="option" value="initDealer"/>
                                    ...
                                    <table  id="data" width=100%  border=0 cellspacing=1 cellpadding=1 bordercolor=#cccccc bgcolor=#cccccc>
                                        <tr bgcolor="#eeeeee" height="20">
                                            <td   align="center" width="20" style="padding-left:3px;FONT-SIZE: 11px;font-weight:bold;padding-right:3px;" >S.No</td>
                                            <td   align="left" width="20" style="padding-left:3px;FONT-SIZE: 11px;font-weight:bold;padding-right:3px;"  nowrap>Dealer Code</td>
                                            <td   align="left" width="30" style="padding-left:3px;FONT-SIZE: 11px;font-weight:bold;padding-right:3px;"  nowrap>Dealer Name</td>
                                            <td   align="left" width="20" style="padding-left:3px;FONT-SIZE: 11px;font-weight:bold;padding-right:3px;"  nowrap>Location Code</td>
                                            <%--<td   align="left" width="20" style="padding-left:3px;FONT-SIZE: 11px;font-weight:bold;padding-right:3px;"  nowrap>Region</td>--%>
                                            <td   align="left" width="25" style="padding-left:3px;FONT-SIZE: 11px;font-weight:bold;padding-right:3px;"  nowrap>Location</td>
                                            <td   align="left" width="25" style="padding-left:3px;FONT-SIZE: 11px;font-weight:bold;padding-right:3px;"  nowrap>Address</td>
                                            <td   align="center" width="20" style="padding-left:3px;FONT-SIZE: 11px;font-weight:bold;padding-right:3px;" nowrap>Edit</td>
                                            <td   align="center" width="20" style="padding-left:3px;FONT-SIZE: 11px;font-weight:bold;padding-right:3px;" nowrap>Status</td>
                                        </tr>
                                        <c:set var="sno" value="1"></c:set>
                                        <logic:iterate id="dealerList" name="dealerList">
                                            <pg:item>
                                                <tr id ="${sno}" height="20">
                                                    <td align="center" bgcolor="#FFFFFF" width="10" class="headingSpas" style="padding-left:5px; padding-right: 5px">${sno}</td>
                                                    <td title="${dealerList.dealerCode}" align="left" bgcolor="#FFFFFF" width="20" class="headingSpas" style="padding-left:5px; padding-right: 5px">
                                                        <span id ="compType${sno}" >
                                                            ${dealerList.dealerCode}
                                                        </span>
                                                    </td>
                                                    <td title="${dealerList.dealerName}" align="left" bgcolor="#FFFFFF" width="30" class="headingSpas" style="padding-left:5px; padding-right: 5px">
                                                        <span id ="compType${sno}" >
                                                            ${dealerList.dealerName}
                                                        </span>
                                                    </td>
                                                    <td title="${dealerList.locationCode}" align="left" bgcolor="#FFFFFF" width="20" class="headingSpas" style="padding-left:5px; padding-right: 5px">
                                                        <span id ="compType${sno}" >
                                                            <c:set var="userNameStr" value="${dealerList.locationCode}"/>
                                                            <c:set var="userNameStr2" value="${fn:substring(userNameStr, 0, 15)}" />
                                                            ${userNameStr2}
                                                        </span>
                                                    </td>
                                                    <td  title="${dealerList.location}" align="left" bgcolor="#FFFFFF" width="20" class="headingSpas" style="padding-left:5px; padding-right: 5px">
                                                        <span id ="compType${sno}" >
                                                            ${dealerList.location}
                                                        </span>
                                                    </td>

                                                    <td title="${dealerList.address1}" align="left" bgcolor="#FFFFFF" width="20" class="headingSpas" style="padding-left:5px; padding-right: 5px">
                                                        <span id ="desc${sno}" >
                                                            <%--   ${dealerList.designation}--%>

                                                            <c:set var="designStr" value=" ${dealerList.address1}"/>
                                                    ...
                                                    <td align="center" bgcolor="#FFFFFF" width="20" class="headingSpas" style="padding-left:5px; padding-right: 5px">
                                                        <span id ="imageButton${sno}" >
                                                            <%--<img src="${pageContext.request.contextPath}/images/edit.gif" onclick="editRow('${dealerList.name}', ${sno}, '${dealerList.id}', '${dealerList.designation}')" title="Edit"/>--%>
                                                            <a href='<%=cntxpath%>/UserManagement.do?option=getDealerData&dealerCode=${dealerList.dealerCode}'><img src="${pageContext.request.contextPath}/images/edit.gif"  title="Edit"/></a>
                                                        </span>
                                                    </td>
                                                    <td align="center" bgcolor="#FFFFFF" width="25" class="headingSpas" style="padding-left:5px; padding-right: 5px">
                                                        <span id ="st${sno}" >
                                                            <a href="javascript:void(0)" onclick="cUDAction('${dealerList.status}', ${sno}, '${dealerList.dealerCode}')"  class="headingSpas" style="color: blue;" >
                                                                <c:if test="${dealerList.status=='A'}">Active</c:if>
                                                                <c:if test="${dealerList.status=='I'}">Inactive</c:if>
                                                                <%--  ${dealerList.status}&nbsp;--%>
                                                            </a>
                                                        </span>
                                                    </td>
