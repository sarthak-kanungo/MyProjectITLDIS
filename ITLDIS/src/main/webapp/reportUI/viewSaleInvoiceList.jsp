...
<%
            ...
            File source_file = new File(saveLocation + "PartSummaryReportExcel.xls");
            source_file.delete();
            String radio = request.getParameter("radio");
            String fileDownloadPath = "";
            if (radio != null) {
                if (radio.equals("part Wise")) {
                    fileDownloadPath = saveLocation + "PartWiseSummaryReportExcel.xls";
                } else {
                    fileDownloadPath = saveLocation + "CustomerWiseSummaryReportExcel.xls";
                }
            }
...
<div class="contentmain1">
    ...
    <div class="breadcrumb_container">
        <ul class="hText">
            ...
            <li><bean:message key="label.report.SaleInvoiceReport" /></li>
        </ul>
    </div>
    <center>
        <div class="content_right1">
            <div class="con_slidediv2" style="position: relative;width: 100%">
                <h1 class="hText"><bean:message key="label.report.SaleInvoiceReport" /></h1>
                <div style="overflow: auto">
                    <table  width=100%  border=0 cellspacing=0 cellpadding=4 bordercolor=#cccccc bgcolor=#cccccc>
                        <tr height=50 bgcolor="#FFFFFF">
                            <td align= center class="headingSpas">
                                <html:form action="reportAction.do?option=createSaleInvoiceReport&flag=check" method="post"  styleId="searchBy" onsubmit="donotsubmit();">
                                    ...
                                    <table width=80% align="left" border=0 cellspacing=0 cellpadding=4 bgcolor=#cccccc>
                                        ...
                                        <tr bgcolor="#FFFFFF">
                                            ...
                                            <td  align="left">
                                                <select id="Country" name="country"  >
                                                    ...
                                                    <%}%>
                                                    <c:forEach items="${countryList}"  var="labelValue">//Country
                                        ...
                                        <tr bgcolor="#FFFFFF">
                                            <td align="right"  style="padding-right:10px;padding-top:10px" >
                                                <%if (radio != null) {%>
                                                <%if (radio.equals("part Wise")) {%>
                                                <input type="radio" checked name="radio" id="Radio1" value="part Wise" />
                                                <%} else {%>
                                                <input type="radio"  name="radio" id="Radio1" value="part Wise" />
                                                <%}
                                                } else {%>
                                                <input type="radio" checked name="radio" id="Radio1" value="part Wise" />
                                                <%}%>
                                            </td>
                                            <td align="left"  style="padding-left:10px;padding-top: 10px;" nowrap>
                                                <bean:message key="label.report.PartWise" />
                                            </td>
                                        </tr>
                                        <tr bgcolor="#FFFFFF">
                                            <td  align="right"  style="padding-right:10px;padding-top:10px;">
                                                <%if (radio != null) {%>
                                                <%if (radio.equals("part Wise")) {%>
                                                <input type="radio" name="radio" id="Radio1" value="Customer Wise" />
                                                <%} else {%>
                                                <input type="radio" checked name="radio" id="Radio1" value="Customer Wise" />
                                                <%}
                                                } else {%>
                                                <input type="radio" name="radio" id="Radio1" value="Customer Wise" />
                                                <%}%>
                                            ...
                                            <td  align="left"  style="padding-left:10px;padding-top:10px;" nowrap>
                                                <bean:message key="label.report.CustomerWise" />
                                            </td>
                                        </tr>
                                        <tr bgcolor="#FFFFFF">
                                ...
                                <table width="95%" border="0" cellspacing="2" cellpadding="2" bgcolor="#ffffff">
                                    <tr>
                                        <td class="red" width="50%" align="center">
                                            ...
                                            <b>Sale Invoice Report Exported in Excel Successfully.</b><br>
                                            <br>
                                            <a href=<%=fileDownloadPath%> style="color:red;"><b>Click here to Download</b></a>
                                            <%}%>

                                            <%if (message.equals("FAILURE")) {%>
                                            Sales Invoice Report can not be Exported. Please Contact Administrator.<br>
                                            <br>
