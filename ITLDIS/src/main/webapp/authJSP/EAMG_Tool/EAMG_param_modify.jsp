...
<html:html >
    <head>
        ...
        <script type="text/javascript">
            var param=<%=paramvec.size()%>
            function validate()
            {
                var flag=false;
                for(i=0;i<(param+1);i++)
                {
                    if(document.getElementById('valcheckbox'+i).checked==false)
                    {
                        flag=true;
                    }
                    else
    ...
    <body>
        <%
                    String tdData = "MANAGE " +"" + comp_type + " >> MODIFY " + "" + comp_type + " >> MODIFICATION PARAMETERS";
            ...
            <table width="700" border="0" cellspacing="1" cellpadding="1">
                ...
                <tr>
                    <td align="center"><table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC">
                            <tr>
                                <td height="25" align="left" class="blue"><b class="path">&nbsp;Manage <%=comp_type%> >> <%=comp_type%> Modify >> Modification Parameters</b></td>
                            </tr>
                        </table></td>
                </tr>
                <tr>
                    ...
                    <td valign="top"><table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC">
                            ...
                            <tr>
                                <td align="center" valign="top" bgcolor="#FFFFFF">
                                    <form name="myform" method="post"  action="<%=contextPath%>/EAMG_update_comp.do">
                                        <br />
                                        ...
                                        <table width="95%" border="0" cellspacing="2" cellpadding="2">
                                            ...
                                            <tr>
                                                <td height="25" align="center" class="text"><label>
                                                        <input type="checkbox" name="descheckbox" id="valcheckbox0" value="deschecked" />
                                                    </label></td>
                                                <td height="25" align="left" class="text">&nbsp;Component Description</td>
                                            ...
                                            <tr>
                                                <td height="25" align="center" class="text"><label>
                                                        <input type="checkbox" name="checkbox" id="valcheckbox<%=(i + 1)%>" value="<%=paramvec.elementAt(i)%>" />
                                                    </label></td>
                                                <td height="25" align="left" class="text">&nbsp;<%=paramvec.elementAt(i)%> </td>
