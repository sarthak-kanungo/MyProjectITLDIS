            ...
            %>
                ...
                function validate()
                {
                    ...
                    if(partdesc=="" || partdesc==null)
                    {
                        ...
                        if(res==false)
                        {
                            alert('Tool Description can not contain any special characters.');
                            form1.part_desc.value="";
                            form1.part_desc.focus();
                            return false;
                        }
                    ...
                    if(part_rmk!=""){
                        ...
                        if(res==false)
                        {
                            alert('Tool Remarks can not contain any special characters.');
            ...
            <table width="700" border="0" cellspacing="1" cellpadding="1">
                ...
                <%-- <tr>
                     <td align="center"><table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC">
                             <tr>
                                 <td height="25" align="left" class="blue"><b class="path">&nbsp;Manage Tool >> Modify Tool >> Tool Details</b></td>
                             </tr>
                         </table></td>
                 </tr>--%>
                <tr>
                    ...
                    <td valign="top"><table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC">
                            ...
                            <tr>
                                <td align="center" valign="top" bgcolor="#FFFFFF">
                                    <form name="form1"  action="<%=contextPath%>/EAMG_ModifyPartByExcel.do" onsubmit="return validate();">
                                        <br />
                                        <table width="95%" border="0" cellspacing="2" cellpadding="2">
                                            ...
                                            <tr>
                                                <td height="25" align="left" class="text">&nbsp;Tool Description</td>
                                            ...
                                            <tr>
                                                <td height="25" align="left" class="text">&nbsp;Tool Remarks</td>
                                                <td height="25" align="left" class="text"><label>
