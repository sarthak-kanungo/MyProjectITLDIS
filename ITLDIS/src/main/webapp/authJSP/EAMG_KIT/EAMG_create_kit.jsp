...
<html>
    <head>
        ...
        <%
                    ...
                    session.setAttribute("comp_type", "KIT");
        ...
        <script language=javascript>
            ...
            {        
                ...
                {
                    document.form1.action="<%=context%>/EAMG_create_ass_wz.do";
                }
                else
                {
                    if(document.form1.radio3.checked==true)           
                        document.form1.action="<%=context%>/create_kit.do";
            ...
            function create_template()
            {
                ...
                var url='<%=context%>/authJSP/EAMG_Group/EAMG_create_template_save.jsp?comp_type=KIT';
