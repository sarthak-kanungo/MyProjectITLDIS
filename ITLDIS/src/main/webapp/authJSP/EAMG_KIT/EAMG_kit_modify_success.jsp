<%-- 
    Document   : amw_kit_modify_success
...
<html>
    ...
    <head>
        ...
        <%
                    ...
                    String result = "";
                    result = "Kit '" + comp_param_list + "' modified successfully.";
            ...
            <table width="700" border="0" cellspacing="1" cellpadding="1">
               ...
               <%-- <tr>
                ...
                <tr><td class="red" align="center">
                        <%=result%><br>
                        <font class="red-for-temmplate-link" ><a href="javascript:location.href='<%=context%>/authJSP/EAMG_KIT/EAMG_kit_modify_comptype.jsp';">Modify More</a></font>
                    </td>
                </tr>
            </table>
        </div>
