    ...
    <head>
        ...
        <%
                    ...
                    if (comp_type.equals("PRT")) {
                        result = "Part '" + comp_param_list + "' modified successfully.";
                    }
    ...
    <body>
        ...
        <div align="center">
            <table width="700" border="0" cellspacing="1" cellpadding="1">
               ...
               <tr><td class="red" align="center" height="30">
                        <%=result%><br>
                        <font class="red-for-temmplate-link" ><a href="javascript:location.href='<%=context%>/authJSP/EAMG_Part/EAMG_comp_modify.jsp';">Modify More</a></font>
                    </td></tr>
            </table>
        </div>
        <%
