...
<script type="text/javascript" language="javascript">
   ...
   function submitForm()
   {
      var dealerFlag='<%=dealerFlag%>';
       ...
       document.getElementById("warrantyClaimStatusDashboard").submit();
 ...
 <div class="contentmain1">
     <div class="breadcrumb_container">
         <ul class="hText">
            ...
            <li class="breadcrumb_link"><bean:message key="label.common.warrantyDashboard" /></li>
         </ul>
     </div>
 ...
 <center>
     ...
     <div class="content_right1">
         <div class="con_slidediv2" style="position: relative;width: 100%">
             <h1 class="hText"><bean:message key="label.common.warrantyDashboard" /></h1>
             <table  width=100%  border=0 cellspacing=0 cellpadding=4 bordercolor=#cccccc bgcolor=#cccccc>

                  <tr height=50 bgcolor="#FFFFFF">
                     <td align= center class="headingSpas">
                     <form name="warrantyClaimStatusDashboard" id="warrantyClaimStatusDashboard" method="post" action="<%=cntxpath%>/warrantyAction.do?option=warrantyClaimStatusDashboard&flag=check" onsubmit="return false;">
                        ...
                        <tbody >
                            <tr bgcolor="#FFFFFF">
                                ...
                                <td  style="padding-left:5px;width:5% "  class="headingSpas" nowrap align="right">
                                    ...
                                    <bean:message key="label.warranty.claimDate"/></td>
                                ...
                                <td style="padding-left:5px;width:5%" align="left">
                                   <input name="toDate" type="text" class="datepicker" id="To Date" value="${toDate}" style="width:60px" onkeydown="return false;"/>
                                </td> --%>
                                       ...
                                       <td align="left">
                                        ...
                                        <td  style="padding-left:1px;width:0.5% "  class="headingSpas" nowrap align="left"><bean:message key="label.common.to"/></td>
                                        <td   align="left">
                               ...
                               <input name="go" type="submit" id="go" class="headingSpas1" value="Export" onclick="Export()"/>
               ...
               <c:if test="${!empty warrantyClaimStatusList}">
                        <tr height=25 bgcolor="#FFFFFF">
                            <td align= center class="headingSpas">
                                <pg:pager url="warrantyAction.do" maxIndexPages="10" maxPageItems="15">
                                    <pg:param name="option" value="warrantyClaimStatusDashboard"/>
                                    ...
                                    <table width=100%  border=0 cellspacing=1 cellpadding=1 >
                                        <tr bgcolor="#eeeeee" height="20">
                                            <td nowrap align="center" width="5%" rowspan="2" style="font-weight:bold;" >
                                                <bean:message key="label.common.sno" />
                                            </td>
                                            <td nowrap align="center" width="15%" style="FONT-SIZE: 11px;font-weight:bold;" >
                                                <bean:message key="label.common.noOfClaims" />
                                            </td>
                                            <td nowrap align="center" width="10%" style="font-weight:bold;" >
                                                <bean:message key="label.common.noOfClaims" />
                                            </td>
                                            <td nowrap align="center" width="15%" style="font-weight:bold;" >
                                                <bean:message key="label.common.noOfClaims" />
                                            </td>
                                            <td nowrap align="center" width="10%" style="font-weight:bold;" >
                                                <bean:message key="label.common.noOfClaims" />
                                        ...
                                        <tr bgcolor="#eeeeee" height="20">
                                            ...
                                            <td nowrap align="center" width="15%" style="FONT-SIZE: 11px;font-weight:bold;" >
                                                <bean:message key="label.common.warrantyNoOfClaimsPendingForCreation" />
                                            </td>
                                            <td nowrap align="center" width="10%" style="font-weight:bold;" >
                                                <bean:message key="label.common.warrantyNoOfClaimsCreated" />
                                            </td>
                                       
                                            <td nowrap align="center" width="10%" style="font-weight:bold;" >
                                                <bean:message key="label.common.warrantyNoOfClaimsPacked" />
                                            </td>
                                            <td nowrap align="center" width="10%" style="font-weight:bold;" >
                                                <bean:message key="label.common.warrantyNoOfClaimsDispatched" />
                                            </td>
                                            <td nowrap align="center" width="15%" style="font-weight:bold;" >
                                                <bean:message key="label.common.warrantyNoOfClaimsReceivedToWarrantyTeam" />
                                            </td>
                                            <td nowrap align="center" width="15%" style="font-weight:bold;" >
                                               <bean:message key="label.common.warrantyNoOfClaimsApproved" />
                                            </td>
                                            <td nowrap align="center" width="15%" style="font-weight:bold;" >
                                               <bean:message key="label.common.warrantyNoOfClaimsTaxInvoiceReceivedToWarrantyTeam" />
                                            </td>
                                            <td nowrap align="center" width="15%" style="font-weight:bold;" >
                                               <bean:message key="label.common.warrantyNoOfClaimsCreditNoteIssued" />
                                            </td>
                                        ...
                                        <logic:iterate id="warrantyClaimStatusList" name="warrantyClaimStatusList">
                                            <pg:item>
                                                <tr  bgcolor="#eeeeee" height="20">
                                                    <td nowrap align="center" bgcolor="#FFFFFF" style="FONT-SIZE: 11px;" >${sno}</td>
                                                    <td align="center"  bgcolor="#FFFFFF" style="FONT-SIZE: 11px;">${warrantyClaimStatusList.noOfClaimsPendingForCreation}</td>
                                                    <td align="center" nowrap   bgcolor="#FFFFFF" style="FONT-SIZE: 11px;">${warrantyClaimStatusList.noOfClaimsCreated}</td>
                                                    <td align="center"   bgcolor="#FFFFFF" style="FONT-SIZE: 11px;"><span >${warrantyClaimStatusList.noOfClaimsPacked}</span></td>
                                                    <td align="center"   bgcolor="#FFFFFF" style="FONT-SIZE: 11px;"><span >${warrantyClaimStatusList.noOfClaimsDispatched}</span></td>
                                                   <td align="center" nowrap   bgcolor="#FFFFFF" style="FONT-SIZE: 11px;">${warrantyClaimStatusList.noOfClaimsReceivedToWtyTeam}</td>
                                                    <td align="center"   bgcolor="#FFFFFF" style="FONT-SIZE: 11px;"><span >${warrantyClaimStatusList.noOfClaimsApproved}</span></td>
                                                    <td align="center"   bgcolor="#FFFFFF" style="FONT-SIZE: 11px;"><span >${warrantyClaimStatusList.noOfClaimsTaxInvoiceReceivedToWtyTeam}</span></td>
                                                    <td align="center"   bgcolor="#FFFFFF" style="FONT-SIZE: 11px;"><span >${warrantyClaimStatusList.noOfClaimsCreditNoteIssued}</span></td>
