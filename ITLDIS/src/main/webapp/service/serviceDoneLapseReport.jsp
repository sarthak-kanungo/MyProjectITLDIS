<%--
    Document   : serviceDoneLapseReport
 ...
 <div class="contentmain1">
     <div class="breadcrumb_container">
         <ul class="hText">
            ...
            <li class="breadcrumb_link"><bean:message key="label.common.serDoneLapseReprt" /></li>
         </ul>
     </div>
 ...
 <center>
     ...
     <div class="content_right1">
         <div class="con_slidediv2" style="position: relative;width: 100%">
             <h1 class="hText"><bean:message key="label.common.serDoneLapseReprt" /></h1>
             <table  width=100%  border=0 cellspacing=0 cellpadding=4 bordercolor=#cccccc bgcolor=#cccccc>
                 <tr height=50 bgcolor="#FFFFFF">
                     <td align= center class="headingSpas">
                     <form name="serviceReminderList" id="myForm" method="post" action="<%=cntxpath%>/serviceProcess.do?option=initServiceDoneLapse&flag=check" onsubmit="return false;">
                        ...
                        <tr height=25 bgcolor="#FFFFFF">
                            <td align= center class="headingSpas">
                                <pg:pager url="serviceProcess.do" maxIndexPages="10" maxPageItems="15">
                                    <pg:param name="option" value="initServiceDoneLapse"/>
                                    ...
                                    <table width=100%  border=0 cellspacing=1 cellpadding=1 bordercolor=#cccccc bgcolor=#cccccc>
                                        ...
                                        <logic:iterate id="sercviceReminderList" name="sercviceReminderList">
                                            <pg:item>
                                                <tr  bgcolor="#eeeeee" height="20">
                                                    ...
                                                    <td align="left"   bgcolor="#FFFFFF" style="padding-left:3px;FONT-SIZE: 11px;white-space: nowrap"><span >${sercviceReminderList.jobCardNo} [${sercviceReminderList.jobCardDate}]</span></td>
                                        ...
                                        <tr>  <%if (userFunctionalities.contains("101")){%>
