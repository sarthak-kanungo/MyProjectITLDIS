...
public class Dealervslocationcode implements Serializable {
...
//    private Integer id;
    ...
    public Dealervslocationcode(Integer id) {
        this.dealerCode = dealerCode;
    }

    public Dealervslocationcode(Integer id, String dealerCode, String locationCode) {
//        this.id = id;
        this.dealerCode = dealerCode;
...
//    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Dealervslocationcode)) {
            return false;
        }
        Dealervslocationcode other = (Dealervslocationcode) object;
    ...
    public String toString() {
        return "beans.Dealervslocationcode[dealerCode=" + dealerCode + "]";
    }
