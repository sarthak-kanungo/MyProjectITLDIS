#!/usr/bin/env python3
"""
Script to convert ITLDIS Spares Module UML Class Diagram from markdown file to JPEG image
"""
...
def mermaid_to_jpeg(mermaid_code, output_path, title="Spares Module UML Diagram", width=12000, height=8000):
...
def main():
    """Main function to convert Spares Module UML diagram"""
    ...
    markdown_file = script_dir / "SPARES-MODULE-UML-DIAGRAM.md"
    ...
    output_filename = "Spares-Module-UML-Class-Diagram.png"
    ...
    try:
        ...
        old_jpg = output_dir / "Spares-Module-UML-Class-Diagram.jpg"
        if old_jpg.exists():
            old_jpg.unlink()
            print(f"   Deleted old JPG file: {old_jpg}")
        
        mermaid_to_jpeg(diagram, output_path, "Spares Module UML Class Diagram", width=12000, height=8000)
