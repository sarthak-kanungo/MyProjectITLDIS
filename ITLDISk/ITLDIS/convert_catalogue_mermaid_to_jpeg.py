#!/usr/bin/env python3
"""
Script to convert Catalogue Module Mermaid diagrams from markdown file to JPEG images
"""
...
def main():
    ...
    markdown_file = script_dir / "CATALOGUE_MODULE_SEQUENCE_DIAGRAMS.md"
    output_dir = script_dir / "CatalogueFlow"
