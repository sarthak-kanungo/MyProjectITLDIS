#!/usr/bin/env python3
"""
Script to convert Report Module Mermaid diagrams from markdown file to JPEG images
"""
...
def main():
    ...
    markdown_file = script_dir / "REPORT_MODULE_SEQUENCE_DIAGRAMS.md"
    output_dir = script_dir / "ReportFlow"
