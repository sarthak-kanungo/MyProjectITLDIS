#!/usr/bin/env python3
"""
Script to convert Mermaid diagrams from markdown file to JPEG images
"""
...
def mermaid_to_jpeg(mermaid_code, output_path, title="Diagram", width=2400, height=1600):
...
def main():
    ...
    for i, (diagram_code, title) in enumerate(zip(diagrams, titles), 1):
        ...
        try:
            mermaid_to_jpeg(diagram_code, output_path, title, width=2400, height=1600)
        except Exception as e:
