...
<div class="contentmain1">
    <div class="breadcrumb_container">
        <ul class="hText">
            ...
            <li class="breadcrumb_link"><bean:message key="label.report.gstr1" /></li>
        </ul>
    </div>
    ...
    <center>
        ...
        <div class="content_right1">
            <div class="con_slidediv2" style="position: relative;width: 100%; padding-bottom: 10px;">
                <h1 class="hText"><bean:message key="label.report.gstr1" /></h1>
                <html:form action="reportAction.do?option=generateGstr1Report" method="post" styleId="searchBy">
