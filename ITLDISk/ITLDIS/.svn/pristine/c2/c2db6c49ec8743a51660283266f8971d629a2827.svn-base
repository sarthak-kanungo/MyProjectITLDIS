...
public class Eventmaster implements Serializable {
    ...
    public Eventmaster(Integer id, String eventName, String eventPlace, Date startDate, Date endDate, String dealerCode) {
        this.id = id;
    ...
    public String toString() {
        return "HibernateMapping.Eventmaster[id=" + id + "]";
    }
