                    ...
                    <td colspan="2">
                        <table width="100%" border="0" align="center" cellpadding="3" cellspacing="0" bordercolor=#cccccc >
                            <tr height=20 bgcolor="#FFFFFF">
                                ...
                                <td align="left" ><span>${serviceForm.refNo}</span>
                                </td>
                                <td align="right" ><label ><B><bean:message key="label.common.billNo" />: </B></label></td>
                                <td align="left" ><span>${serviceForm.billto_str}</span>
                                </td>
                            </tr>
                            <tr height=20 bgcolor="#FFFFFF">
                                <td align="right" ><label ><B><bean:message key="label.common.vandorName" />: </B></label></td>
                                <td align="left" ><span>${serviceForm.customerName}</span>
                                </td>
                                <td align="right" ><span><label ><B><bean:message key="label.common.billdate" />: </B></label></span></td>
                                <td align="left" ><span>${serviceForm.invoicedate}</span>
                                </td>
                            </tr>
                                    ...
                                    <td align="left" colspan="6">
                                        <table  border="0" cellspacing="3" cellpadding="3" width="100%" style="FONT-SIZE: 11px;">
                                            <tr class="grid">
                                                ...
                                                <td align="center" width="8%"><B> <bean:message key="label.common.qty_small" /></B></td>
                                                <td align="right" width="8%"><B><bean:message key="label.common.unitprice_small" /></B></td>
                                                <td align="right" width="8%"><B><bean:message key="label.common.amt_small" /> </B></td>
                                            </tr>
                                            <c:set var="j" value="1"></c:set>
                                            <c:forEach items="${datalist}" var="datalist">
                                                <tr >
                                                    <td align="center" class="tdgridnew1" style="FONT-SIZE: 11px;">${j}</td>
                                                    <td align="left"><span>${datalist.partNo_str}</span>
                                                    </td>
                                                    <td align="left"><span>${datalist.partDesc_str}</span>
                                                    </td>
                                                    <td align="center"  ><span>${datalist.qty_str}</span>
                                                    </td>
                                                    <td align="right"><span>${datalist.unitprice_str}</span>
                                                    </td>
                                                    <td align="right"><span>${datalist.totalPartsValue}</span>
                                                    </td>
                                                </tr>
                                                <c:set var="j" value="${j + 1 }" />
                                            </c:forEach>
                                            <tr class="grid">
                                                <td colspan="5" align="right" width="6%" ><B><bean:message key="label.common.totalAmmount" /> </B></td>
                                                <td align="right" width="6%"><B>${serviceForm.subTotal}</B></td>
                                            </tr>
                                            <tr>
                                                <td colspan="5" align="right" width="6%" ><B><bean:message key="label.spare.taxValue" /> </B></td>
                                                <td align="right" width="6%"><B>${serviceForm.taxValue}</B></td>
                                            </tr>
                                            <tr>
                                                <td colspan="5" align="right" width="6%" ><B><bean:message key="label.common.GrandTotal" /> </B></td>
                                                <td align="right" width="6%"><B>${serviceForm.totalEstimate}</B></td>
                                        </table>
                                    </td>
                                </tr>
                            </c:if>
