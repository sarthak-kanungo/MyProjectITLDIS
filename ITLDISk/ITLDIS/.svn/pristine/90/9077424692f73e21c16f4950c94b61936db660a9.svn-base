...
<%
            ...
            String[] tempVar = (String[]) request.getAttribute("tempVar");
            ...
            <table width="700" border="0" cellspacing="1" cellpadding="1">
                ...
                <%--<tr>
                    <td align="center"><table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#cccccc">
                            <tr>
                                <td height="25" align="left" class="blue"><b class="path">&nbsp;Manage <%=PageTemplate.GROUP%>s >> Delete Unused <%=PageTemplate.GROUP%>s </b></td>
                            </tr>
                        </table></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td class="red" align="center"><%=result%></td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                </tr>
                ...
                <tr>   <td align="center">
                        <table width="60%" border="0" cellpadding="1" cellspacing="1" bordercolor="#cccccc" bgcolor="#000000">
                            <tr>
                                <td  height="25" colspan="2" align="center" class="blue"><strong class="heading">List of Deleted <%=PageTemplate.GROUP%>s</strong></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td width="30%" align="center" bgcolor="#FFFFFF" class="text"><%=tempVar[i]%></td>
                            </tr>
                            <%}
                                        }%>
                        </table></td>
