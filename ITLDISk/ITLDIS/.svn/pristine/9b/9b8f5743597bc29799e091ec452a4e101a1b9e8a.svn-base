...
<script type="text/javascript">
    ...
    function submitSearchByForm(){
       ...
       var url="reportAction.do?option=getRollingSpareLubeReport&flag=DLR&finYear=" + finYear + "&month="+month;
        window.open(url);       
    }
...
<html>
    ...
    <div class="breadcrumb_container">
        <ul class="hText">
            ...
            <li><bean:message key="label.report.spareAndLubeRolling" /></li>
        </ul>
    </div>
    ...
    <center>
        <div class="content_right1">
            <div class="con_slidediv2" >
                <h1 class="hText"><bean:message key="label.report.spareAndLubeRolling" /></h1>
                <table  width=100%  border=0 cellspacing=0 cellpadding=4 bordercolor=#cccccc bgcolor=#cccccc>
                    <tr height=50 bgcolor="#FFFFFF">
                        <td align= center class="headingSpas">
                            
                            <html:form action="reportAction.do?option=getRollingSpareLubeReport&flag=DLR" method="post" styleId="searchBy" onsubmit="return false;">         <%--onsubmit="return submitSearchByForm();"--%>
