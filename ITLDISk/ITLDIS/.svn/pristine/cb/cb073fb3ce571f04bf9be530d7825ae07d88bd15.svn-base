...
<script type="text/javascript">
    ...
    function submitSearchByForm(){
        ...
        var url="reportAction.do?option=spareAndLubeReport&flag=DLR&country="+country+ "&zone="+zone
     ...
     function getListOnSelectCountry(obj) {
        ...
        conId = replaceall(conId, " ", "@");       
            ...
            else
            {
                    $.ajax({
                        type: "POST",
                        url: "reportAction.do?option=getSubFieldDetails&getColName=PKZoneID,ZoneDesc&whereColName=COUNTRY&flag=DLR&colValue="+conId,
    ...
    function getListOnSelectZone(obj) {
        ...
        else
        {
                 $.ajax({
                type: "POST",
                url: "reportAction.do?option=getSubFieldDetails&getColName=StateID,StateName&whereColName=PKZoneID&flag=DLR&colValue="+zoneId,
     ...
     function getListOnSelectState(obj) {
        ...
        else
        {
            $.ajax({
            type: "POST",
            url: "reportAction.do?option=getSubFieldDetails&getColName=CCMID,CCM&whereColName=STATEID&flag=DLR&colValue="+stateId,
    ...
    function getListOnSelectCcm(obj) {
        ...
        else
        {
            $.ajax({
                type: "POST",
                url: "reportAction.do?option=getSubFieldDetails&getColName=CCEID,CCE&whereColName=CCMID&flag=DLR&colValue="+ccmId,
     ...
     function getListOnSelectCce(obj) {
        ...
        if(cceId=='All')
        {
            ...
            $.ajax({
                type: "POST",
                url: "reportAction.do?option=getSubFieldDetails&getColName=DEALER_CODE,DEALER_NAME,LOCATION&whereColName=CCEID&flag=DLR&colValue="+cceId,
...
<html>
    ...
    <div class="breadcrumb_container">
        <ul class="hText">
            ...
            <li><bean:message key="label.report.spareAndLube" /></li>
        </ul>
    </div>
    ...
    <center>
        <div class="content_right1">
            <div class="con_slidediv2" >
                <h1 class="hText"><bean:message key="label.report.spareAndLube" /></h1>
                <table  width=100%  border=0 cellspacing=0 cellpadding=4 bordercolor=#cccccc bgcolor=#cccccc>
                    <tr height=50 bgcolor="#FFFFFF">
                        <td align= center class="headingSpas">

                            <html:form action="reportAction.do?option=spareAndLubeReport&flag=DLR" method="post" styleId="searchBy" onsubmit="return false;">
                                <table width=100%  border=0 cellspacing=0 cellpadding=0 bgcolor=#FFFFFF>
                                    ...
                                    <tr>
                                        <td  style="padding-left:10px; padding-right: 10px; padding-top: 10px" class="headingSpas" nowrap align="right" width="60px">
                                            <span class="formLabel"><bean:message key="label.common.ccm" /></span>
                                        </td>
                                        ...
                                        <td  style="padding-left:10px; padding-right: 10px;padding-top: 10px" class="headingSpas" nowrap align="right" width="60px">
                                            <span class="formLabel"><bean:message key="label.common.cce" /></span>
                                        </td>
                                        <td align="left" style="padding-top: 10px">
                                        ...
                                        <td  style="padding-left:10px; padding-right: 10px; padding-top: 10px" class="headingSpas" nowrap align="right" width="60px">
                                            <span class="formLabel"><bean:message key="label.common.dealer" /></span>
                                        </td>
