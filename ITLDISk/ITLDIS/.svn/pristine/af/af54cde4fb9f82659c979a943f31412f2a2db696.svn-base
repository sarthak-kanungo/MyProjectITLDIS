            ...
            <script language="javascript"> 
                function check_method_select()
                {
                    if(document.form1.comp_detail.checked==true){
                        document.form1.action="<%=context%>/authJSP/EAMG_KIT/EAMG_modify_kit_details.jsp";
                    }else{
                        document.form1.action="<%=context%>/authJSP/EAMG_KIT/EAMG_create_kit_bom.jsp";
                    }
                    return true;
                }
                function compdet()
                ...
                function CancelProcess()
                {
                    ...
                    //if(cncl==true)
                    {
                        location.href="<%=context%>/authJSP/EAMG_KIT/EAMG_kit_modify_comptype.jsp";
                    }
                }
        </script>
                                            ...
                                            <tr>
                                                <td colspan="3">
                                                    <table width="100%" border="0" cellspacing="2" cellpadding="2">
                                                        <tr>
                                                            <td width="30%" align="left" class="text">&nbsp;Kit Number :</td>
