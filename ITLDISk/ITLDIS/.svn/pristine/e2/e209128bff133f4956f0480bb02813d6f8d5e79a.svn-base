...
public class ViewModel_pictureView1 extends HttpServlet {
...
//                }
                ...
                if (userFunctionalities.contains("230")) {
                    ...
                    ps.println("<IMG SRC=" + imagesURL + "list.gif border = 0 width=18 height=20 alt=\"" + ComUtils.getLanguageTranslation("label.catalogue.groupListView", session) + "\" style=\"z-index:0;\">");
                    ps.println("</a>");
                    ps.println("</td>");
                }
//
...
//                }
                ...
                ps.println("<td>");
                ps.println("<br>");
                ps.println(object_pageTemplate.tableHeader(ComUtils.getLanguageTranslation("label.catalogue.groupsAvailable", session) + " : " + aggregate, width, height));
...
//                        ps.println("<tr><td colspan=16 align=center class=links_txt valign=top width=100% ><b>" + ("" + groupTypes.elementAt(i)).toUpperCase() + "</td></tr>");
//                    }
                    ...
                    for (int k = 0; k < groupArray.size(); k = k + 3) {
                        ...
                        ps.println("<table border=0 cellspacing=1 cellpadding=1 width = 25% valign=top align=center>");
                        ps.println("<tr>");
