<%-- 
    Document   : viewOrderEXPList
    Created on : Jan 4, 2016, 2:59:15 PM
            ...
            <div class="con_slidediv2" style="position: relative;width: 100%">
                ...
                <table  width=100%  border=0 cellspacing=0 cellpadding=4 bordercolor=#cccccc bgcolor=#cccccc>
                    <tr height=50 bgcolor="#FFFFFF">
                        <td align= center class="headingSpas">
                            <html:form action="inventoryEXPAction.do?option=viewEXPOrder&flag=check" method="post" styleId="searchBy" >
                                    ...
                                    <tr bgcolor="#FFFFFF" >
                                        ...
                                        <td align="left" width="10%">
                                            <select id="OrderStatus" name="status" class="headingSpas" style="width:110px !important;" <%--onchange="makeEnable(this.value)"--%>>
                                                ...
                                                <option value="PI DONE" >PI DONE</option>
                ...
                <c:if test="${!empty viewOrderList}">
                    ...
                    <pg:pager url="inventoryEXPAction.do" maxIndexPages="10" maxPageItems="10">
                        <pg:param name="option" value="viewEXPOrder"/>
                        ...
                        <div style="width:99%; overflow:auto">
                            <table width=100%  border=0 cellspacing=1 cellpadding=1 bordercolor=#cccccc bgcolor=#cccccc>
                                <tr bgcolor="#eeeeee" height="20">
                                    ...
                                    <td   align="left"  class="headingSpas" width="7%" nowrap style="padding-left:5px; "><b><bean:message key="label.spare.PODate" /> </b></td>
                                    <td   align="left"  class="headingSpas" width="6%" nowrap style="padding-left:5px; "><b><bean:message key="label.spare.noOfLines" /> </b></td>
                                    <%if (userFunctionalities.contains("101")) {%>
                                    <%} else {%>
                                    <td   align="left"  class="headingSpas" width="10%" nowrap style="padding-left:5px; "><b><bean:message key="label.common.dealerName" /></b></td>
                                    <%}%>
                                    <td   align="left"  class="headingSpas" width="6%" nowrap style="padding-left:5px; "><b><bean:message key="label.spare.orderType" /></b></td>
                                    <td   align="left"  class="headingSpas" width="5%" nowrap style="padding-left:5px; "><b> <bean:message key="label.common.status" /></b></td>
                                    ...
                                    <td   align="left"  class="headingSpas" width="10%" nowrap style="padding-left:5px; "><b> <bean:message key="label.spare.dischargePortName" /></b></td>
                                ...
                                <logic:iterate id="dataList" name="viewOrderList">
                                    <pg:item>
                                        <tr  bgcolor="#eeeeee" height="20">
                                            ...
                                            <td align="left" bgcolor="#FFFFFF" title="${dataList.poDate}" width="7%" class="headingSpas" style="padding-left:5px; padding-right: 5px">
                                                <span>
                                                    ${dataList.poDate}
                                                </span>
                                            </td>

                                            <td align="center" bgcolor="#FFFFFF" width="6%"  class="headingSpas" style="padding-left:5px; padding-right: 5px">
                                                <span >
                                                    ${dataList.partCount}
                                                </span>
                                            </td>
                                            ...
                                            <%}%>
                                            <td align="center" bgcolor="#FFFFFF" width="6%" title=" ${dataList.orderType}"  class="headingSpas" style="padding-left:5px; padding-right: 5px">
                                                <span>
                                                    ${dataList.orderType}
                                                </span>
                                            </td>
                                            <td align="center" bgcolor="#FFFFFF" width="5%" title=" ${dataList.status}"  class="headingSpas" style="padding-left:5px; padding-right: 5px">  <%--;white-space: nowrap;--%>
                                                ${dataList.status}
                                            </td>
                                            <%if (userFunctionalities.contains("101")) {%>
                                            ...
                                            <td align="left" bgcolor="#FFFFFF" width="10%" title="${inventoryForm.dischargePort}"  class="headingSpas" style="padding-left:5px; padding-right: 5px;white-space: nowrap">
                                                ${dataList.dischargePort}
                                            </td>
