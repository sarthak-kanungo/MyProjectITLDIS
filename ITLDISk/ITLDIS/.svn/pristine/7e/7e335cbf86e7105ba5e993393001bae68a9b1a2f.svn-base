 ...
 */
public class EAMG_commonUtilMethods{
     ...
     public static long getDifferenceOfDates(Date fromDate, Date toDate)
     {
      ...
      //to get CD Number.
    public static int getCD_No(Connection conn) throws Exception {
        int cd_no = 0;
        try {
    ...
    /// to get Patch Number.
    public static int getPatch_No(Connection conn) throws Exception {
        int patch_no = 0;
        try {
            //Statement st = conn.createStatement();
        	PreparedStatement st  = null;
