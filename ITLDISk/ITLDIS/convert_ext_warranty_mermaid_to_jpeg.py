#!/usr/bin/env python3
"""
Script to convert Extended Warranty Registration Module Mermaid diagrams from markdown file to JPEG images
"""
...
def main():
    ...
    markdown_file = script_dir / "EXT_WARRANTY_REG_MODULE_SEQUENCE_DIAGRAMS.md"
    output_dir = script_dir / "ExtWarrantyFlow"
