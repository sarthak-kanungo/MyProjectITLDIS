#!/usr/bin/env python3
"""
Script to convert Login Module Mermaid diagrams from markdown file to JPEG images
"""
...
def main():
    ...
    markdown_file = script_dir / "LOGIN_MODULE_SEQUENCE_DIAGRAMS.md"
    output_dir = script_dir / "LoginFlow"
