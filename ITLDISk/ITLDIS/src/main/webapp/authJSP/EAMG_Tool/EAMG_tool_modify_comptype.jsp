...
<%
            ...
            try {
                ...
                String query = "Select * from cat_part where part_type in('Tool','Lube')";
...
<html:html >
    <head>
        ...
        <script type="text/javascript">
            function validate(myform)
            {
                ...
                var myform=myform;
					 //alert(document.myform.radio2.checked);
                if(document.myform.radio2.checked==false && document.myform.comp_type.value=="")
                {
                ...
                if(document.myform.radio2.checked==true)
                {
                    ...
                    if(xlsfile=="")
                    {
                        alert('Please Browse excel file to modify Component.');
                        return false;
                    }
                    else
                    {
                ...
                else
                {
                    ...
                    if(compno=='')
                    {
                        alert('Please Enter the Component Number.');
            ...
            {
                var url='<%=contextPath%>/authJSP/EAMG_Part/EAMG_create_template_save.jsp?comp_type=TOOL';
                //var type=document.getElementById("comp_type").value;
                //var url="EAMG_create_template_with_data.jsp?comp_type=TOOL";
                //alert(url);
    ...
    <body>
        <%
                    String tdData = "MANAGE COMPONENT >> MODIFY COMPONENT";
            ...
            <table width="700" border="0" cellspacing="1" cellpadding="1">
                ...
                <%-- <tr>
						  <td align="center"><table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC">
									 <tr>
										  <td height="25" align="left" class="blue"><b class="path">&nbsp;Manage Component >> Modify Component</b></td>
									 </tr>
								</table></td>
					 </tr>
					 <tr>
					 ...
					 <tr>
						  <td valign="top"><table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#CCCCCCC">
									 <tr>
										  <td height="25" align="left" class="blue"><b class="heading">&nbsp;MODIFY COMPONENT</b></td>
									 </tr>--%>

                <tr>
                    <td valign="top" class="red" align="center">No Component exists in Database.</td>
                </tr>
            ...
            <table width="700" border="0" cellspacing="1" cellpadding="1">
                ...
                <tr>
                    <td align="center" valign="top" bgcolor="#FFFFFF">
                        <form name="myform" method="post" enctype="multipart/form-data"  action="<%=context%>/EAMG_modify_tool_by_excel.do" onsubmit="return validate(this);">
                            <br />
                            ...
                            <table width="95%" border="0" cellspacing="2" cellpadding="2">
                                ...
                                <tr>
                                    <td  width="6%" align="center" class="text">

                                    </td>
                                    <td  width="34%" align="left" class="text">&nbsp;Select Component Type: &nbsp; </td>
                                ...
                                <tr>
                                    ...
                                    <td  width="34%" align="left" class="text">&nbsp;Component Number </td>
