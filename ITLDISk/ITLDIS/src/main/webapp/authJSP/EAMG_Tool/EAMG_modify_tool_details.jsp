...
<%
            ...
            Vector typeVec = methodutil.getCategoryTypes(conn, comp_type);
            String heading = null;
            int width = 659;
            int height = 84;
...
<html>
    <head>
        ...
        <script language="javascript">
            ...
            <%
                        ...
                        File tool_image = null;
                        try {
                            comp_no = ((String) session.getAttribute("comp_param_list")).toUpperCase();
                            iscomppresent = (String) session.getAttribute("iscomppresent");
                            String type = comp_type;


                            String path = mainURL + "dealer/ecat_print/tool_image/" + comp_no + ".jpg";
                            String tool_image_path = ecatPath + "dealer/ecat_print/tool_image/" + comp_no + ".jpg";
                            tool_image = new File(tool_image_path);
                            ...
                            if (rs.next()) {
                                tool_type = rs.getString("part_type");
            ...
            %>
                ...
                function CancelProcess()
                {
                    ...
                    //if(cncl==true)
                    parent.content.location="<%=contextPath%>/authJSP/EAMG_Tool/EAMG_tool_modify_comptype.jspEAMG_delete_unused_tools.jsp";
    ...
    <body>
        <%
                                    ...
                                    tdData = "MANAGE " + "" + comp_type.toUpperCase() + " >> MODIFY " + "" + comp_type.toUpperCase() + " >> " + "" + comp_type.toUpperCase() + " DETAILS";
        ...
        <div align="center">
            <table width="700" border="0" cellspacing="1" cellpadding="1">
                ...
                <tr>
                    <td align="center" class="red"><%=comp_type%> '<%=comp_no%>' does not exist in database. </td>
                </tr>
                ...
                <tr>
                    <td align="center" valign="top" bgcolor="#FFFFFF">
                        <form name="myform" ENCTYPE="multipart/form-data" action="<%=contextPath%>/EAMG_modify_tool.do" onsubmit="return validate(this);" method="post"><input type="hidden" name="comp_type"  value="<%=comp_type%>">
                            <br />
                            <table width="95%" border="0" cellspacing="2" cellpadding="2">
                                ...
                                <tr>
                                    <td height="25" align="left" class="text">&nbsp;<%=type%> Remarks</td>
                                    <td height="25" align="left" class="text"><label>
                                            <input type="text" size=15 name="tool_rmk" id="tool_rmk" value="<%=remarks%>" style="width:'100px'" class="text" onblur="stringOnlyValidation(document.myform.kit_rmk);this.value=TrimAll(this.value)" />
                                        </label></td>
                                </tr>
                                <%
                                                if (tool_image.length() > 0) {%>
                                        ...
                                        <table width="100%" border="0" cellpadding="1" cellspacing="1">
                                            <tr>
                                                ...
                                                <td width="44%" height="25" align="right" bgcolor="#FFFFFF" class="text">
                                                    &nbsp;&nbsp;&nbsp;<select name="categoryType" id="categoryType" style="width:190px" onchange="enableCategoryOther()" class="text">
                                                ...
                                                <td width="35%" height="25" align="left" bgcolor="#FFFFFF"><span class="text">
