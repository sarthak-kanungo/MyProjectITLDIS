    ...
    <body>
        ...
        <div align="center">
            <table width="700" border="0" cellspacing="1" cellpadding="1">
                ...
                <tr>
                    <td align="center"> <font class="red-for-temmplate-link"><a href="javascript:location.href='<%=contextPath%>/authJSP/EAMG_Part/EAMG_upload_pricelist_excel.jsp'"><%=message.get(1)%></a></font></td>
                </tr>
