...
<html>
    ...
    <body>
        ...
        <div align="center">
            <%
                        if (result.indexOf("Modified Successfully.") != -1) {
            %>
            ...
            <br>
            <font class="red"><%=result%></font><br><font class="red-for-temmplate-link"><a href="javascript:location.href='<%=contextPath%>/authJSP/EAMG_Variant/EAMG_modify_model_bypass.jsp';">Modify More</a></font>

            <%
               }else if(result.indexOf("Status Modified Successfully.") != -1)
                   {
                   %>
                     <br>
                     <font class="red"><%=result%></font><br><font class="red-for-temmplate-link"><a href="javascript:location.href='<%=contextPath%>/authJSP/EAMG_Variant/EAMG_modify_model_bypass.jsp';">Modify More</a></font>
