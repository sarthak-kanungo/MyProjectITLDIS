 ...
 <center>
     ...
     <div class="content_right1">
         <div class="con_slidediv2" style="position: relative;width: 100%; padding-bottom: 10px;">
             <h1 class="hText"><bean:message key="label.report.misfordealer" /></h1>
              <html:form action="reportAction.do?option=generateMisReport" method="post" styleId="searchBy">
                  ...
                  <table width=100%  border=0 cellspacing=0 cellpadding=4 align="center">
                                 ...
                                 <td align="right" width="5%" style="white-space: nowrap;"> <bean:message key="label.common.dealerName" />    </td>
                                     <td align="left" width="20%">
                                         <select id="dealerCode" style="width:238px !important">
