...
<%
            response.setHeader("Content-Disposition", "attachment; filename=SAPInvoiceList.xls");
...
<c:if test="${!empty viewOrderList}">
        <div style="width:99%; overflow:auto">
            <h3 class="hText" align="center"> <bean:message key="label.spare.sapInvoiceList" /></h3>
