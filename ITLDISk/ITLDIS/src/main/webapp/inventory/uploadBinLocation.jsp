<%-- 
    Document   : uploadBinLocation
    Created on : Dec 20, 2014, 5:20:50 PM
    Author     : megha.pandya
--%>
...
<script type="text/javascript" language="javascript">
    ...
    function validateExcel()
    {
        ...
        document.form1.action="<%=cntxpath%>/inventoryAction.do?option=uploadBinLocationExcel";
...
<div class="breadcrumb_container">
    <ul>
        ...
        <li><bean:message key="label.common.uploadBinLoc" />  </li>
...
<div class="content_right1">
            <div class="con_slidediv1" style="position: relative;width: 100%">
                 <h1><bean:message key="label.common.uploadBinLoc" /></h1>

<form name="form1" id="form1" method="post" onsubmit="return check_method_select();" ENCTYPE="multipart/form-data">
    <input type="hidden" name="upperLink" value="<a href='${pageContext.request.contextPath}/inventoryAction.do?option=initInvOptions'><bean:message key='label.common.spares'/></a>@@<bean:message key="label.common.uploadBinLoc" />"/>
    <table width="100%" border="0" cellspacing="0" align="left" class="LiteBorder">
        ...
        <tr>
            <td  align = right style="padding-right:200px;">
                <a href = '<%=cntxpath%>/templates/Inventory_binlocation.xls' style="color:red !important; text-decoration: none">
