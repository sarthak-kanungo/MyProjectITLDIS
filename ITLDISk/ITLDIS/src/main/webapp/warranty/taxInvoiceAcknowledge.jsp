...
function downloadTaxInvoice(packingNo) {
   ...
   function performAction() {
                               ...
                               <table id="data" width=100%  border=0 cellspacing=1 cellpadding=1 bordercolor=#cccccc bgcolor=#cccccc>
                                   ...
                                   <logic:iterate id="claimInvoiceList" name="claimInvoiceList">
                                       <tr id ="${sno}" height="20">
                                           ...
                                           <td align="left" bgcolor="#FFFFFF" title="  ${claimInvoiceList.claimDate}"  class="headingSpas" style="padding-left:5px; padding-right: 5px">
                                               <span id ="compType${sno}" >
                                                   ${claimInvoiceList.claimDate}
                                               </span>
                                           </td>
    ...
    <input type="button" name="Submit" value="SUBMIT" onclick="submitForm()" style="vertical-align: middle;" />
</div>

<div style="display: inline-block; margin-left: 10px;">
    <a href="<%=cntxpath%>/warrantyAction.do?option=downloadTaxInvoice&packingNo=${warrantyForm.packingNo}" target="_blank" style="text-decoration: none;">
        <span>
            <img src="${pageContext.request.contextPath}/image/download.jpg" height="25" width="25" title="Download tax invoice" style="vertical-align: middle;" />
        </span>
    </a>
</div>
