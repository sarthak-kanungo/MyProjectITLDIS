 ...
 <div class="contentmain1">
     <div class="breadcrumb_container">
         <ul class="hText">
             ...
             <li class="breadcrumb_link" ><a href='<%=cntxpath%>/warrantyAction.do?option=taxAcknowledgement'><bean:message key="label.common.taxInvoiceAcknowledgeView" /></a></li>
            <li class="breadcrumb_link"><bean:message key="label.common.taxInvoiceAcknowledgeView" /></li>
         </ul>
     </div>
 ...
 <center>
     ...
     <div class="content_right1">
         <div class="con_slidediv2" style="position: relative;width: 100%">
             <h1 class="hText"><bean:message key="label.common.taxInvoiceAcknowledge" /></h1>
             <table  width=100%  border=0 cellspacing=0 cellpadding=4 bordercolor=#cccccc bgcolor=#cccccc>

                  <tr height=50 bgcolor="#FFFFFF">
                     <td align= center class="headingSpas">
                     <form name="pendingForAcknow" id="myForm" method="post" action="<%=cntxpath%>/warrantyAction.do?option=taxInvoiceAcknowledgeViewList&flag=check" onsubmit="return false;">
                        ...
                        <tbody >
                            <tr bgcolor="#FFFFFF">
                                ...
                                <td  style="padding-left:5px;width:5% "  class="headingSpas" nowrap align="right">
                                    ...
                                    <bean:message key="label.common.taxInvoiceUploadDate"/></td>
                        ...
                        <tr height=25 bgcolor="#FFFFFF">
                            <td align= center class="headingSpas">
                                <pg:pager url="warrantyAction.do" maxIndexPages="10" maxPageItems="15">
                                    <pg:param name="option" value="taxInvoiceAcknowledgeViewList"/>
                                            ...
                                            <pg:item>
                                                <tr  bgcolor="#eeeeee" height="20">
                                                    ...
                                                    <td align="left"   bgcolor="#FFFFFF" style="padding-left:3px;FONT-SIZE: 11px;"><span >${packingList.courierNo} [${packingList.courierName}]</span></td>
                                                      ...
                                                      <%if (userFunctionalities.contains("710")) {%>
                                                    <td align="left"   bgcolor="#FFFFFF" style="padding-left:3px;FONT-SIZE: 11px;">
                                                        <span ><a href="warrantyAction.do?option=taxInvoiceAcknowledge&packingNo=${packingList.packingNo}" >ACKNOWLEDGE</a></span>
                                                    </td>
                                                    <%}%>
