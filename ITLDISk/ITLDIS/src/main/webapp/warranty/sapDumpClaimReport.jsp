...
<div class="contentmain1">
    <div class="breadcrumb_container">
        <ul>
            ...
            <li class="breadcrumb_link"><label><bean:message key="label.common.SAPDumpClaimReport" /></label></li>
        </ul>
    </div>
    ...
    <center>
        <div class="content_right1">
            <div class="con_slidediv1" style="position: relative;width: 100%">
                <h1><bean:message key="label.common.SAPDumpClaimReport" /></h1>
                ...
                <table id="data" width=100%  border=0 cellspacing=1  cellpadding=4 bordercolor=#cccccc bgcolor=#cccccc>
                    ...
                    <tr height=50 bgcolor="#FFFFFF">
                        <td colspan="11" align= center class="headingSpas">
                            <html:form action="warrantyAction.do?option=sapDumpClaimReoprt&flag=check" method="post" styleId="searchBy" onsubmit="donotsubmit();">
                                <table width=100%  border=0 cellspacing=0 cellpadding=4 bgcolor=#cccccc>
                                    <tr bgcolor="#FFFFFF" >
                                        ...
                                        <td class="headingSpas" nowrap align="right">
                                            ...
                                            <bean:message key="label.warranty.claimApprovalDate" />
                                        </td>
                                        <td align="left">
                                        ...
                                        <%}%>
                                            ...
                                            <input name="go" type="button" value="SAP DUMP CLAIM REPORT" style="float:none; " onClick = "submitForm()"/>
