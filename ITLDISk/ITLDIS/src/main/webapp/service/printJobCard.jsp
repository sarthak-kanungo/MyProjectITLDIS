<%-- 
    ...
    Created on : Nov 19, 2014, 3:12:57 PM
    Author     : megha.pandya
--%>
        ...
        <div class="con_slidediv2" style="position: relative;width: 100%">
          <%--  <h1 class="hText" style="FONT-SIZE: 11px;"><bean:message key="label.common.viewjobCard" /></h1>--%>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="4" style="FONT-SIZE: 11px;">
                      ...
                      <tr>
                          <td align="right"><label ><B><bean:message key="label.service.reasonForDealy" />: </B></label></td>
                          ...
                          <td align="right"><label class="hText"><B><bean:message key="label.common.VorJobCard" />: </B></label></td>
