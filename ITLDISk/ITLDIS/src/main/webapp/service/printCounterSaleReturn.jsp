                ...
                <tr>
                    <td colspan="2">
                            ...
                            <table width="100%" border="0" align="center" cellpadding="3" cellspacing="0" bordercolor=#cccccc >
                                ...
                                <td align="right" ><label ><B><bean:message key="label.spares.returnNo" />: </B></label></td>
                                <td align="left" ><span>${serviceForm.refNo}</span>
                                </td>

                                <td align="right" ><span><label ><B><bean:message key="label.saleReturn.ReturnDate" />: </B></label></span></td>
                              ...
                              <tr height=20 bgcolor="#FFFFFF">
                               ...
                               <td align="right" ><label ><B><bean:message key="label.saleReturn.ReturnBy" />: </B></label></td>
                               <td align="left" ><span>${serviceForm.customerName}</span>
                                ...
                                <td align="left" ><span>${serviceForm.invoiceno}</span>
                                </td>
                              </tr>
                                  ...
                                  <td align="left" colspan="6">
                                      <table  border="0" cellspacing="3" cellpadding="3" width="100%" style="FONT-SIZE: 11px;">
                                          <tr class="grid">
                                              ...
                                              <td align="center" width="10%"><B>  <bean:message key="label.saleReturn.ReturnQty" /></B></td>
                                              <td align="right" width="10%"><B><bean:message key="label.common.unitprice_small" /></B></td>
                                              <td align="right" width="10%"><B><bean:message key="label.saleReturn.ReturnAmount" /> </B></td>
                                          ...
                                          <c:forEach items="${datalist}" var="datalist">
                                              <tr >
                                                  ...
                                                  <td align="center"><span>${datalist.invoiceQty}</span>
                                                    
                                                  </td>
                                                    <td align="center"  ><span>${datalist.recdQty}</span>
                                            ...
                                            <tr class="grid">
                                                <td colspan="6" align="right" width="6%" ><B><bean:message key="label.common.totalReturnAmmoun" /> </B></td>
