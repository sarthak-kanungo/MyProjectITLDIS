var GB_CURRENT=null;
var callBackUrlGlobal=null;
var chassisNoGlobal=null;
GB_hide=function(a){
    GB_CURRENT.hide(a)
};
...
function decoGreyboxLinksModify(pageURL,callBackUrl,chassisNo){
    GB_showCenter("",SERVLET_ROOT_DIR+pageURL,440,900,callBackFun1);
    callBackUrlGlobal=callBackUrl;
    chassisNoGlobal=chassisNo;
}



function decoGreyboxLinks(pageURL,callBackUrl){
    GB_showCenter("",SERVLET_ROOT_DIR+pageURL,440,900,callBackFun);
    callBackUrlGlobal=callBackUrl;
    //rowIdGlobal=rowId;
...
{
    window.location.href=callBackUrlGlobal;
}
function callBackFun1()
{
    window.location.href=callBackUrlGlobal;
    //getChassisDispatchDetailsAjax(chassisNoGlobal);
}
...
function stateChanged(xmlHttp)
{
    ...
    //document.getElementById('myTable').rows[rowIdGlobal].cells[6].innerHTML='';
    //document.getElementById('myTable').rows[rowIdGlobal].cells[6].innerHTML=res.split("$#$#")[1];
    //document.getElementById('myTable').rows[rowIdGlobal].cells[7].innerHTML='';
    //document.getElementById('myTable').rows[rowIdGlobal].cells[7].innerHTML=res.split("$#$#")[2];
...
function openGroupPopUp(){
    ...
    GB_showCenter("",SERVLET_ROOT_DIR+"Groups_BG.html",600,600);
...
GB_Window=GreyBox.extend({
    init:function(a){
        ...
        this.img_close=this.root_dir+"button_cancel.png";
...
AJS.preloadImages(GB_ROOT_DIR+"button_cancel.png",GB_ROOT_DIR+"header_bg.gif");
script_loaded=true;