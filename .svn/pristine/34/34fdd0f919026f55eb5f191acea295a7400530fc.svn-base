...
import { RetailFinanceDetailsV2WebService } from '../../pre-sales/enquiry-v2/services/retail-finance-details-v2-web.service';
...
@Component({
  ...
  providers: [SalesReportService, RetailFinanceDetailsV2WebService, EnquiryReportService]
})
export class EnquiryReportComponent implements OnInit {

  financierList: Array<any>
  ...
  constructor(private retailFinanceDetailsV2WebService: RetailFinanceDetailsV2WebService,
    private reportService : SalesReportService,
    private enquiryService: EnquiryReportService,
  ...
  this.searchGroupForm.controls.financier.valueChanges.subscribe(value => {
    if(value){
