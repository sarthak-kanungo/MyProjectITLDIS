...
export class OrghierarchyModalService {
  ...
  private readonly getEmpMasterdepartment=`${environment.baseUrl}${urlService.api}${urlService.kubotaemployee}${urlService.empMasterdepartmentForOrgHier}`
  private readonly levelForOrgHier=`${environment.baseUrl}${urlService.api}${urlService.kubotaemployee}${urlService.levelForOrgHier}`
  private readonly levelDetailsForOrgHier=`${environment.baseUrl}${urlService.api}${urlService.kubotaemployee}${urlService.levelDetailsForOrgHier}`
  private readonly assigneDept=`${environment.baseUrl}${urlService.api}${urlService.kubotaemployee}${urlService.assigneDeptInOrgHier}`
  private readonly getOrgHierDetailsForHoEmp=`${environment.baseUrl}${urlService.api}${urlService.kubotaemployee}${urlService.orgHierDetailsForHoEmp}`
  private readonly updateHoOrgHierStatus=`${environment.baseUrl}${urlService.api}${urlService.kubotaemployee}${urlService.updateHoOrgHierStatus}`
