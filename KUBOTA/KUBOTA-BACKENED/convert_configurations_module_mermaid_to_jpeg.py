#!/usr/bin/env python3
"""
Script to convert Configurations Module Mermaid diagrams from markdown file to JPEG images
"""
...
def main():
    ...
    markdown_file = script_dir / "CONFIGURATIONS_MODULE_SEQUENCE_DIAGRAMS.md"
    output_dir = script_dir / "ConfigurationsFlow"
