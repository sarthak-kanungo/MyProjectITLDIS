package com.i4o.dms.kubota.masters.service.checkpointspecification.repository;

import com.i4o.dms.kubota.masters.service.checkpointspecification.domain.CheckpointSpecification;
