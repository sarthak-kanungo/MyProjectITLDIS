package com.i4o.dms.kubota.spares.inventorymanagement.branchtransfer.branchtransferreciept.domain;
...
@Setter
@Entity
@Table(name = "SP_BRANCH_TRANSFER_RECEIPT_ITEM")
public class SPBranchTransferReceiptItem {
	...
	private SPBranchTransferReceipt transferReceipt;
