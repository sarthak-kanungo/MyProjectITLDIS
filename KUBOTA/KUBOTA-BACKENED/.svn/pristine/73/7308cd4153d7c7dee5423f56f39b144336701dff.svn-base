package com.i4o.dms.kubota.aop;
...
import com.i4o.dms.kubota.salesandpresales.purchase.purchaseOrder.repository.PurchaseOrderRepo;
import com.i4o.dms.kubota.salesandpresales.purchase.purchaseOrder.repository.SalesPoApprovalRepository;
...
public class  PurchaseOrderAop {
   ...
   /* @AfterReturning(value = "execution (* com.i4o.dms.kubota.salesandpresales.purchase.purchaseOrder.controller.PurchaseOrderController.savePurchaseOrder(..))",
            returning = "retVal")
...
/*
    @AfterReturning(value = "execution (* com.i4o.dms.kubota.salesandpresales.purchase.purchaseOrder.controller.PurchaseOrderController.approvePurchaseOrder(..)) && args(poApproval,..)",
            returning = "retVal")
