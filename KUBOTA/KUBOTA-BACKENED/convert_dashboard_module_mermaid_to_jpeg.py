#!/usr/bin/env python3
"""
Script to convert Dashboard Module Mermaid diagrams from markdown file to JPEG images
"""
...
def main():
    ...
    markdown_file = script_dir / "DASHBOARD_MODULE_SEQUENCE_DIAGRAMS.md"
    output_dir = script_dir / "DashboardFlow"
