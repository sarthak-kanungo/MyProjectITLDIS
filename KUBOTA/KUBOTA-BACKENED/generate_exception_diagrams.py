#!/usr/bin/env python3
"""
Script to generate all sequence diagram images from EXCEPTION_MODULE_SEQUENCE_DIAGRAMS.md
"""
...
def main():
    """Main function to generate all exception diagrams"""
    ...
    for i in range(len(diagrams)):
        if i < len(titles):
            ...
            diagram_configs.append({
                'index': i,
                'title': f"Diagram {i+1}",
                'filename': f"{str(i+1).zfill(2)}_{i+1}-Exception-Diagram-{i+1}.jpg"
            })
