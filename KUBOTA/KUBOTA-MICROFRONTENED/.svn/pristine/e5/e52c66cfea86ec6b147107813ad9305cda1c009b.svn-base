...
import { JobCardReopenApprovalRoutingModule } from './job-card-reopen-approval-routing.module';
...
@NgModule({
  declarations: [ApprovalDetailsComponent,JobCardDetailsComponent, ServiceJobCardComponent, PartRequisitionComponent, LabourChargesComponent, OutsideJobChargesComponent, CustomerConcernComponent, JobCardCreateComponent, SearchJobCardPageComponent, HoursPopUpComponent],
  imports: [
    CommonModule,
    JobCardReopenApprovalRoutingModule,
    MaterialModule,
    FormsModule,
    ReactiveFormsModule,
    MaterialModule,
...
export class JobCardReopenApprovalModule { }
