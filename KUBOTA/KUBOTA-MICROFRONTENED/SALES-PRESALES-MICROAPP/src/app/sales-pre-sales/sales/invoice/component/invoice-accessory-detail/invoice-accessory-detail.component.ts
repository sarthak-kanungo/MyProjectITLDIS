...
export class InvoiceAccessoryDetailComponent implements OnInit {
  ...
  disableTotalInvoiceCalcFormAtCancelInvoice() {
    if (this.isCancelInvoice || this.isView) {
      this.totalInvoiceCalcForm.disable();
    }
  }
  private patchValueToTotalInvoiceCalcFormForCancelInvoice(invoiceDetail) {
    ...
    this.totalInvoiceCalcForm.get('baseAmount').patchValue(invoiceDetail.totalBasicAmount || null);
    this.totalInvoiceCalcForm.get('totalGSTAmount').patchValue(invoiceDetail.totalGstAmount || null);
    this.totalInvoiceCalcForm.get('totalInvoiceAmount').patchValue(invoiceDetail.totalInvoiceAmount || null);
