...
export class DeliveryProspectDetailsService {
  ...
  createProspectDetailsForm() {
    this.prospectDetailsFrom = this.fb.group({
      ...
      invoiceCustomerName: [{ value: null, disabled: true }, Validators.compose([Validators.required])],
      ...
      mobileNumber: [{ value: null, disabled: true }, Validators.compose([Validators.required, CustomValidators.mobileNumber, CustomValidators.numberOnly, CustomValidators.maxLength(10)])],
