...
export class SpareDescripancyClaimStore {
    ...
    approvalSpareDescripancyForm(){
        ...
        const isKubotaUser = userType['userType'] == 'kubota';
        const approvalForm=this.fb.group({
            remarkForDealer:[{value:null,disabled:false},isKubotaUser ? Validators.required : null],
            internalKaiRemark:[{value:null,disabled:false},isKubotaUser ? Validators.required : null],
            creditNoteNo:[{value:null,disabled:false},isKubotaUser ? Validators.required : null],
            creditNoteDate:[{value:null,disabled:false},isKubotaUser ? Validators.required : null],
            creditNoteAmount:[{value:null,disabled:false},isKubotaUser ? Validators.required : null],
      ...
      partDetails(materialDetail?:any) {
        ...
        const partDetailsForm = this.fb.group({
          ...
          dealerRemarkReasons:[{value:null,disabled:false},isKubotaUser ? null : Validators.required],
          kaiAcceptedQty:[{value:null,disabled:false},isKubotaUser ? Validators.required : null],
          kaiRemarkReason:[{value:null,disabled:false},isKubotaUser ? Validators.required : null],
